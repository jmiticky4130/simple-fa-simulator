...
var $author$project$Main$TutWelcome = {$: 'TutWelcome'};
...
var $author$project$Shared$State = F8(
	function (id, x, y, label, isStart, isEnd, isCompact, startAngle) {
		return {id: id, isCompact: isCompact, isEnd: isEnd, isStart: isStart, label: label, startAngle: startAngle, x: x, y: y};
	});
...
var $author$project$Utils$AutomatonCodec$stateDecoder = A9(
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'isCompact', $elm$json$Json$Decode$bool),
				$elm$json$Json$Decode$succeed(false)
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'startAngle', $elm$json$Json$Decode$float),
				$elm$json$Json$Decode$succeed($elm$core$Basics$pi)
			])));
var $author$project$Shared$Transition = F4(
	function (from, to, symbol, bend) {
		return {bend: bend, from: from, symbol: symbol, to: to};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Utils$AutomatonCodec$transitionDecoder = A5(
...
var $author$project$Main$Flags = F7(
	function (urlData, darkMode, language, windowWidth, windowHeight, hasSeenTutorial, gridMode) {
		return {darkMode: darkMode, gridMode: gridMode, hasSeenTutorial: hasSeenTutorial, language: language, urlData: urlData, windowHeight: windowHeight, windowWidth: windowWidth};
	});
...
var $author$project$Main$flagsDecoder = A8(
	...
	A2($elm$json$Json$Decode$field, 'hasSeenTutorial', $elm$json$Json$Decode$bool),
	A2($elm$json$Json$Decode$field, 'gridMode', $elm$json$Json$Decode$bool));
...
var $author$project$Shared$CompleteDFA = {$: 'CompleteDFA'};
var $author$project$Shared$IncompleteDFA = {$: 'IncompleteDFA'};
var $author$project$Shared$NFA = {$: 'NFA'};
...
var $author$project$Utils$AutomatonHelpers$classifyAutomaton = F2(
	function (states, transitions) {
		var key = function (t) {
		...
		var hasDuplicates = A2(checkDuplicates, transitions, _List_Nil);
		var alphabet = $elm$core$Set$toList(
			$elm$core$Set$fromList(
				A2(
					$elm$core$List$filterMap,
					function (t) {
					...
					transitions)));
		var isComplete = $elm$core$List$isEmpty(alphabet) ? true : A2(
			$elm$core$List$all,
			function (state) {
				return A2(
					$elm$core$List$all,
					function (sym) {
						return A2(
							$elm$core$List$any,
							function (t) {
								return _Utils_eq(t.from, state.id) && _Utils_eq(t.symbol, sym);
							},
							transitions);
					},
					alphabet);
			...
			states);
		return (hasEpsilon || hasDuplicates) ? $author$project$Shared$NFA : ((!isComplete) ? $author$project$Shared$IncompleteDFA : $author$project$Shared$CompleteDFA);
	});
...
var $author$project$Pages$Simulator$init = F2(
	function (language, automaton) {
		...
		var autoType = A2($author$project$Utils$AutomatonHelpers$classifyAutomaton, automaton.states, automaton.transitions);
		var mode = function () {
			if (autoType.$ === 'NFA') {
				return $author$project$Pages$Simulator$NfaMode;
			} else {
				return $author$project$Pages$Simulator$DfaMode;
			}
		}();
		return {
...
var $author$project$Pages$Editor$init = function (language) {
	return {
		...
		bendDragStartX: 0,
		bendDragStartY: 0,
		bendingTransition: $elm$core$Maybe$Nothing,
		consoleMessages: function () {
			var t = $author$project$Utils$Translations$getTranslations(language);
			return _List_fromArray(
				[
		...
		draggingStartArrow: $elm$core$Maybe$Nothing,
...
var $author$project$Main$init = function (flagsValue) {
	var flags = function () {
		...
		if (_v0.$ === 'Ok') {
			...
			return {darkMode: false, gridMode: false, hasSeenTutorial: false, language: 'sk', urlData: $elm$core$Maybe$Nothing, windowHeight: 800, windowWidth: 1200};
		}
	}();
	...
	var loadedAutomaton = A2(
		...
		flags.urlData);
	var editorInitBase = A2($author$project$Pages$Editor$initWith, lang, loadedAutomaton);
	var editorInit = _Utils_update(
		editorInitBase,
	...
	return _Utils_Tuple2(
		{
			...
			gridMode: flags.gridMode,
			guideTab: $author$project$Main$GuideEditor,
			language: lang,
			settingsOpen: false,
			showGuide: false,
			simulatorModel: simulatorInit,
			tutorialStep: (!flags.hasSeenTutorial) ? $elm$core$Maybe$Just($author$project$Main$TutWelcome) : $elm$core$Maybe$Nothing,
...
var $author$project$Main$keyDecoder = function (model) {
	return A5(
		$elm$json$Json$Decode$map4,
		F4(
			function (key, ctrl, shift, tagName) {
				var isTyping = (tagName === 'INPUT') || (tagName === 'TEXTAREA');
				return (key === 'Escape') ? ((!_Utils_eq(model.tutorialStep, $elm$core$Maybe$Nothing)) ? $author$project$Main$EditorMsg($author$project$Pages$Editor$CancelAction) : (model.showGuide ? $author$project$Main$CloseGuide : (model.settingsOpen ? $author$project$Main$CloseSettings : (model.editorModel.showSaveModal ? $author$project$Main$EditorMsg($author$project$Pages$Editor$DismissSaveModal) : (model.editorModel.showLoadModal ? $author$project$Main$EditorMsg($author$project$Pages$Editor$DismissLoadModal) : $author$project$Main$EditorMsg($author$project$Pages$Editor$CancelAction)))))) : (isTyping ? $author$project$Main$EditorMsg($author$project$Pages$Editor$NoOp) : ((ctrl && ((key === 'z') || (key === 'Z'))) ? $author$project$Main$EditorMsg($author$project$Pages$Editor$Undo) : ((ctrl && ((key === 'y') || (key === 'Y'))) ? $author$project$Main$EditorMsg($author$project$Pages$Editor$Redo) : ((shift && ((key === 'b') || (key === 'B'))) ? $author$project$Main$EditorMsg(
					...
					$author$project$Pages$Editor$ChangeTool($author$project$Pages$Editor$DeleteTool)) : $author$project$Main$EditorMsg($author$project$Pages$Editor$NoOp))))));
			}),
...
var $author$project$Main$subscriptions = function (model) {
	var resizeSub = $elm$browser$Browser$Events$onResize($author$project$Main$WindowResize);
...
var $author$project$Main$TutCreateState1 = {$: 'TutCreateState1'};
var $author$project$Main$TutEnterInput = {$: 'TutEnterInput'};
var $author$project$Main$TutToolbarConvert = {$: 'TutToolbarConvert'};
var $author$project$Main$TutToolbarFiles = {$: 'TutToolbarFiles'};
var $author$project$Main$TutToolbarTools = {$: 'TutToolbarTools'};
var $author$project$Main$TutToolbarUndoRedo = {$: 'TutToolbarUndoRedo'};
var $author$project$Main$TutCreateState2 = {$: 'TutCreateState2'};
var $author$project$Main$TutCreateTransition = {$: 'TutCreateTransition'};
var $author$project$Main$TutSetEnd = {$: 'TutSetEnd'};
var $author$project$Main$TutSetStart = {$: 'TutSetStart'};
var $author$project$Main$TutSimulateButton = {$: 'TutSimulateButton'};
var $author$project$Main$advanceTutorialEditor = F2(
	function (step, edModel) {
		var transitions = edModel.automaton.present.transitions;
		var states = edModel.automaton.present.states;
		_v0$5:
		while (true) {
			if (step.$ === 'Just') {
				switch (step.a.$) {
					case 'TutCreateState1':
						var _v1 = step.a;
						return ($elm$core$List$length(states) >= 1) ? $elm$core$Maybe$Just($author$project$Main$TutCreateState2) : step;
					case 'TutCreateState2':
						var _v2 = step.a;
						return ($elm$core$List$length(states) >= 2) ? $elm$core$Maybe$Just($author$project$Main$TutSetStart) : step;
					case 'TutSetStart':
						var _v3 = step.a;
						return A2(
							$elm$core$List$any,
							...
							states) ? $elm$core$Maybe$Just($author$project$Main$TutSetEnd) : step;
					case 'TutSetEnd':
						var _v4 = step.a;
						return A2(
							$elm$core$List$any,
							...
							states) ? $elm$core$Maybe$Just($author$project$Main$TutCreateTransition) : step;
					case 'TutCreateTransition':
						var _v5 = step.a;
						return ($elm$core$List$length(transitions) >= 1) ? $elm$core$Maybe$Just($author$project$Main$TutSimulateButton) : step;
					default:
						break _v0$5;
				}
			} else {
...
var $author$project$Main$TutRunSimulation = {$: 'TutRunSimulation'};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Main$saveTutorialSeen = _Platform_outgoingPort(
	'saveTutorialSeen',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$advanceTutorialSimulator = F3(
	function (step, simMsg, simModel) {
		_v0$2:
		while (true) {
			if (step.$ === 'Just') {
				switch (step.a.$) {
					case 'TutEnterInput':
						var _v1 = step.a;
						return (simModel.inputString !== '') ? _Utils_Tuple2(
							$elm$core$Maybe$Just($author$project$Main$TutRunSimulation),
							$elm$core$Platform$Cmd$none) : _Utils_Tuple2(step, $elm$core$Platform$Cmd$none);
					case 'TutRunSimulation':
						var _v2 = step.a;
						switch (simMsg.$) {
							case 'StepForward':
								return _Utils_Tuple2(
									$elm$core$Maybe$Nothing,
									$author$project$Main$saveTutorialSeen(_Utils_Tuple0));
							case 'AutoStep':
								return _Utils_Tuple2(
									$elm$core$Maybe$Nothing,
									$author$project$Main$saveTutorialSeen(_Utils_Tuple0));
							default:
								return _Utils_Tuple2(step, $elm$core$Platform$Cmd$none);
						}
					default:
						break _v0$2;
				}
...
var $author$project$Utils$ConversionHelpers$dfaSubsetStateToState = function (ds) {
	return {id: ds.id, isCompact: false, isEnd: ds.isEnd, isStart: ds.isStart, label: ds.label, startAngle: $elm$core$Basics$pi, x: ds.x, y: ds.y};
};
	...
	if (_v0.$ === 'Nothing') {
		...
		return {
			...
			transitions: A2(
				$elm$core$List$map,
				function (dt) {
					return {bend: 0, from: dt.from, symbol: dt.symbol, to: dt.to};
				},
				snap.transitions)
		};
	}
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'isCompact',
				$elm$json$Json$Encode$bool(s.isCompact)),
				_Utils_Tuple2(
				'startAngle',
				$elm$json$Json$Encode$float(s.startAngle))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'bend',
				$elm$json$Json$Encode$float(t.bend))
			]));
};
...
var $author$project$Main$saveGridMode = _Platform_outgoingPort('saveGridMode', $elm$json$Json$Encode$bool);
...
var $author$project$Pages$Editor$computeBend = F5(
	function (fromId, toId, mouseX, mouseY, states) {
		var toState = A2($author$project$Utils$AutomatonHelpers$getStateById, toId, states);
		var fromState = A2($author$project$Utils$AutomatonHelpers$getStateById, fromId, states);
		var _v0 = _Utils_Tuple2(fromState, toState);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var fs = _v0.a.a;
			var ts = _v0.b.a;
			if (_Utils_eq(fromId, toId)) {
				var rawAngle = A2($elm$core$Basics$atan2, mouseY - fs.y, mouseX - fs.x);
				return rawAngle + ($elm$core$Basics$pi / 2);
			} else {
				var vy = ts.y - fs.y;
				var vx = ts.x - fs.x;
				var midY = (fs.y + ts.y) / 2;
				var midX = (fs.x + ts.x) / 2;
				var len = $elm$core$Basics$sqrt((vx * vx) + (vy * vy));
				var uxDir = (!len) ? 1 : (vx / len);
				var py = uxDir;
				var uyDir = (!len) ? 0 : (vy / len);
				var px = -uyDir;
				var dmy = mouseY - midY;
				var dmx = mouseX - midX;
				var bendVal = ((dmx * px) + (dmy * py)) * 2;
				return bendVal;
			}
		} else {
			return 0;
...
var $author$project$Pages$Editor$computeStartArrowAngle = F4(
	function (stateId, mouseX, mouseY, states) {
		var _v0 = A2($author$project$Utils$AutomatonHelpers$getStateById, stateId, states);
		if (_v0.$ === 'Just') {
			var s = _v0.a;
			return A2($elm$core$Basics$atan2, mouseY - s.y, mouseX - s.x);
		} else {
...
var $author$project$Pages$Editor$getGroupBend = F3(
	function (fromId, toId, transitions) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
				...
				$elm$core$List$head(
					A2(
						$elm$core$List$filter,
						function (tr) {
							return _Utils_eq(tr.from, fromId) && _Utils_eq(tr.to, toId);
						},
						transitions))));
	});
...
var $author$project$Pages$Editor$selfLoopPopupPos = F3(
	function (stateX, stateY, bend) {
		var midAngle = bend - ($elm$core$Basics$pi / 2);
		var dist = 80;
		return _Utils_Tuple2(
			stateX + (dist * $elm$core$Basics$cos(midAngle)),
			stateY + (dist * $elm$core$Basics$sin(midAngle)));
	});
				...
				if (_v1.$ === 'Nothing') {
					...
					var _v2 = function () {
						...
						if ((_v3.a.$ === 'Just') && (_v3.b.$ === 'Just')) {
							var fs = _v3.a.a;
							var ts = _v3.b.a;
							return _Utils_eq(fromId, stateId) ? A3(
								$author$project$Pages$Editor$selfLoopPopupPos,
								fs.x,
								fs.y,
								A3($author$project$Pages$Editor$getGroupBend, fromId, stateId, currentAutomaton.transitions)) : _Utils_Tuple2((fs.x + ts.x) / 2, (fs.y + ts.y) / 2);
						} else {
...
var $author$project$Pages$Editor$snapToGrid = F2(
	function (gridSize, val) {
		return $elm$core$Basics$round(val / gridSize) * gridSize;
	});
...
var $author$project$Pages$Editor$updateStartAngle = F3(
	function (stateId, angle, states) {
		return A2(
			$elm$core$List$map,
			function (s) {
...
var $author$project$Pages$Editor$updateTransitionBend = F4(
	function (fromId, toId, newBend, transitions) {
		return A2(
			$elm$core$List$map,
			function (tr) {
				return (_Utils_eq(tr.from, fromId) && _Utils_eq(tr.to, toId)) ? _Utils_update(
					tr,
					{bend: newBend}) : tr;
			},
			transitions);
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'SwitchToConversion':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'AddDeadState':
				var _v1 = currentAutomaton;
				var states = _v1.states;
				var transitions = _v1.transitions;
				var avgX = $elm$core$List$isEmpty(states) ? 300 : ($elm$core$List$sum(
					A2(
						$elm$core$List$map,
						function ($) {
							return $.x;
						},
						states)) / $elm$core$List$length(states));
				var existingIds = A2(
					$elm$core$List$map,
					function ($) {
						return $.id;
				...
				var newDeadId = A2(
					$elm$core$Maybe$withDefault,
					$elm$core$List$length(existingIds),
					$elm$core$List$head(
						A2(
							$elm$core$List$filter,
							function (i) {
								return !A2($elm$core$List$member, i, existingIds);
							},
							A2(
								$elm$core$List$range,
								0,
				...
				var minY = A2(
					...
					$elm$core$List$minimum(
						A2(
							...
							states)));
				var deadState = {id: newDeadId, isCompact: false, isEnd: false, isStart: false, label: 'dead state', startAngle: $elm$core$Basics$pi, x: avgX, y: minY - 150};
				var alphabet = $elm$core$Set$toList(
					$elm$core$Set$fromList(
						A2(
							$elm$core$List$filterMap,
							function (tr) {
								return (tr.symbol === '\u03B5') ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(tr.symbol);
							},
							transitions)));
				var missingPairs = A2(
					$elm$core$List$concatMap,
					function (state) {
						return A2(
							$elm$core$List$map,
							function (sym) {
								return _Utils_Tuple2(state.id, sym);
							},
							A2(
								$elm$core$List$filter,
								function (sym) {
									return !A2(
										$elm$core$List$any,
										function (tr) {
											return _Utils_eq(tr.from, state.id) && _Utils_eq(tr.symbol, sym);
										},
										transitions);
								},
								alphabet));
					...
					states);
				var deadTransitions = _Utils_ap(
					A2(
						$elm$core$List$map,
						function (_v2) {
							var fromId = _v2.a;
							var sym = _v2.b;
							return {bend: 0, from: fromId, symbol: sym, to: newDeadId};
						},
						missingPairs),
					A2(
						$elm$core$List$map,
						function (sym) {
							return {bend: 0, from: newDeadId, symbol: sym, to: newDeadId};
						},
						alphabet));
				var newAutomaton = {
					...
					states: _Utils_ap(
						...
						_List_fromArray(
							[deadState])),
					transitions: _Utils_ap(transitions, deadTransitions)
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							consoleMessages: A2(
								$elm$core$List$cons,
								{msgType: $author$project$Components$Console$Info, text: t.editorDeadStateAdded},
								model.consoleMessages)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleConsole':
			...
			case 'ImportJsonContent':
				var content = msg.a;
				var _v3 = A2($elm$json$Json$Decode$decodeString, $author$project$Utils$AutomatonCodec$decoder, content);
				if (_v3.$ === 'Ok') {
					var automaton = _v3.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'SelectStoredAutomaton':
				...
				if (maybeEntry.$ === 'Nothing') {
					...
					var _v5 = A2($elm$json$Json$Decode$decodeString, $author$project$Utils$AutomatonCodec$decoder, entry.data);
					if (_v5.$ === 'Ok') {
						var automaton = _v5.a;
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'CanvasDoubleClick':
				var x = msg.a;
				var y = msg.b;
				var _v7 = model.currentTool;
				if (_v7.$ === 'BuildTool') {
					var rawWorldY = (y - model.panY) / model.zoom;
					var worldY = model.gridMode ? A2($author$project$Pages$Editor$snapToGrid, 60.0, rawWorldY) : rawWorldY;
					var rawWorldX = (x - model.panX) / model.zoom;
					var worldX = model.gridMode ? A2($author$project$Pages$Editor$snapToGrid, 60.0, rawWorldX) : rawWorldX;
					var existingIds = A2(
						$elm$core$List$map,
						function ($) {
							return $.id;
					...
					var newState = {
						...
						isEnd: false,
						isStart: false,
						label: 'q' + $elm$core$String$fromInt(newId),
						startAngle: $elm$core$Basics$pi,
						x: worldX,
						y: worldY
					};
			...
			case 'CanvasClick':
				return model.hasPanned ? _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{editingStateId: $elm$core$Maybe$Nothing, editingTransition: $elm$core$Maybe$Nothing, editingTransitionOldSymbol: $elm$core$Maybe$Nothing, selectedState: $elm$core$Maybe$Nothing, stateLabelInput: '', stateModalIsEnd: false, stateModalIsStart: false, transitionFrom: $elm$core$Maybe$Nothing, transitionInput: ''}),
					$elm$core$Platform$Cmd$none);
			case 'StateClick':
				var stateId = msg.a;
			...
			case 'StateDoubleClick':
				var stateId = msg.a;
				var _v8 = model.currentTool;
				if (_v8.$ === 'BuildTool') {
					var fromState = A2($author$project$Utils$AutomatonHelpers$getStateById, stateId, currentAutomaton.states);
					var _v9 = function () {
						if (fromState.$ === 'Just') {
							var fs = fromState.a;
							return A3(
								...
								fs.x,
								fs.y,
								A3($author$project$Pages$Editor$getGroupBend, stateId, stateId, currentAutomaton.transitions));
						} else {
							return _Utils_Tuple2(400, 300);
						}
					}();
						...
						_Utils_update(
							model,
							{
								consoleMessages: A2(
									...
									model.consoleMessages),
								editingTransition: $elm$core$Maybe$Just(
									{from: stateId, to: stateId, x: inputX, y: inputY}),
								editingTransitionOldSymbol: $elm$core$Maybe$Nothing,
								transitionFrom: $elm$core$Maybe$Nothing,
								transitionInput: ''
							}),
			...
			case 'StateRightClick':
				var stateId = msg.a;
				var _v12 = model.currentTool;
				if (_v12.$ === 'BuildTool') {
			...
			case 'DragMove':
				...
				if (model.isPanning) {
					...
					var _v16 = model.bendingTransition;
					if (_v16.$ === 'Just') {
						var bt = _v16.a;
						var worldY = (y - model.panY) / model.zoom;
						var worldX = (x - model.panX) / model.zoom;
						var dy = worldY - model.bendDragStartY;
						var dx = worldX - model.bendDragStartX;
						var dist = $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
						if ((!model.isBending) && (dist > 5)) {
							var newHistory = A2($elm_community$undo_redo$UndoList$new, currentAutomaton, model.automaton);
							var bendVal = A5($author$project$Pages$Editor$computeBend, bt.from, bt.to, worldX, worldY, currentAutomaton.states);
							var newTransitions = A4($author$project$Pages$Editor$updateTransitionBend, bt.from, bt.to, bendVal, currentAutomaton.transitions);
							var newAutomaton = _Utils_update(
								currentAutomaton,
								{transitions: newTransitions});
							return _Utils_Tuple2(
						...
						var _v17 = model.draggingStartArrow;
						if (_v17.$ === 'Just') {
							var saId = _v17.a;
							var worldY = (y - model.panY) / model.zoom;
							var worldX = (x - model.panX) / model.zoom;
							...
							var dx = worldX - model.bendDragStartX;
							var dist = $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
							if ((!model.isDraggingStartArrow) && (dist > 5)) {
								var newHistory = A2($elm_community$undo_redo$UndoList$new, currentAutomaton, model.automaton);
								var angle = A4($author$project$Pages$Editor$computeStartArrowAngle, saId, worldX, worldY, currentAutomaton.states);
								var newStates = A3($author$project$Pages$Editor$updateStartAngle, saId, angle, currentAutomaton.states);
								var newAutomaton = _Utils_update(
									currentAutomaton,
									{states: newStates});
								return _Utils_Tuple2(
							...
							if (_v18.$ === 'Just') {
								...
								var rawWorldX = (x - model.panX) / model.zoom;
								var worldX = model.gridMode ? A2($author$project$Pages$Editor$snapToGrid, 60.0, rawWorldX) : rawWorldX;
								var dyr = rawWorldY - model.dragStartY;
								var dxr = rawWorldX - model.dragStartX;
								var dist = $elm$core$Basics$sqrt((dxr * dxr) + (dyr * dyr));
			...
			case 'EndDrag':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bendingTransition: $elm$core$Maybe$Nothing, draggedState: $elm$core$Maybe$Nothing, draggingStartArrow: $elm$core$Maybe$Nothing, isBending: false, isDraggingStartArrow: false, isPanning: false}),
					$elm$core$Platform$Cmd$none);
			case 'DeleteState':
				var stateId = msg.a;
				var state = A2($author$project$Utils$AutomatonHelpers$getStateById, stateId, currentAutomaton.states);
						...
						$elm$core$List$sort(
							A2(
								...
								A2(
									...
									currentAutomaton.transitions))));
					var _v20 = function () {
						var _v21 = _Utils_Tuple2(fromState, toState);
						if ((_v21.a.$ === 'Just') && (_v21.b.$ === 'Just')) {
							...
							return _Utils_eq(from, to) ? A3(
								...
								fs.x,
								fs.y,
								A3($author$project$Pages$Editor$getGroupBend, from, to, currentAutomaton.transitions)) : _Utils_Tuple2((fs.x + ts.x) / 2, (fs.y + ts.y) / 2);
						} else {
							return _Utils_Tuple2(400, 300);
						}
					}();
					...
					if ($elm$core$String$isEmpty(
						...
						if (isDuplicate) {
							...
							var statesWithEnd = A2(
								...
								statesWithStart);
							var statesWithCompact = A2(
								$elm$core$List$map,
								function (s) {
									return _Utils_eq(s.id, stateId) ? _Utils_update(
										s,
										{isCompact: model.stateModalIsCompact}) : s;
								},
								statesWithEnd);
							var newAutomaton = _Utils_update(
								currentAutomaton,
								{states: statesWithCompact});
			...
			case 'DismissStateModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editingStateId: $elm$core$Maybe$Nothing, stateLabelInput: '', stateModalIsCompact: false, stateModalIsEnd: false, stateModalIsStart: false}),
					$elm$core$Platform$Cmd$none);
			...
			case 'SetStateModalIsEnd':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{stateModalIsEnd: val}),
					$elm$core$Platform$Cmd$none);
			case 'SetStateModalIsCompact':
				var val = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{stateModalIsCompact: val}),
					$elm$core$Platform$Cmd$none);
			case 'ResetAutomaton':
			...
			case 'UpdateTransitionInput':
				var inputVal = msg.a;
				var allSegmentsValid = A2(
					$elm$core$List$all,
					function (seg) {
						return $elm$core$String$length(seg) <= 1;
					},
					A2(
						$elm$core$List$filter,
						A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
						A2($elm$core$String$split, ' ', inputVal)));
				return allSegmentsValid ? _Utils_Tuple2(
					_Utils_update(
						model,
						{transitionInput: inputVal}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'ConfirmTransitionSymbol':
				var _v25 = model.editingTransition;
				if (_v25.$ === 'Just') {
					var from = _v25.a.from;
					var to = _v25.a.to;
					var _v26 = model.editingTransitionOldSymbol;
					if (_v26.$ === 'Just') {
						var oldSymbol = _v26.a;
						var oldBend = A2(
							$elm$core$Maybe$withDefault,
							0,
							A2(
						...
						var filteredTransitions = (oldSymbol === '__ALL__') ? A2(
							...
							currentAutomaton.transitions);
						if ($elm$core$String$isEmpty(newInput)) {
							if (_Utils_eq(from, to)) {
								...
								if (A2(
									$elm$core$List$any,
									function (tr) {
										return _Utils_eq(tr.from, from) && (_Utils_eq(tr.to, to) && (tr.symbol === 'ε'));
									},
									filteredTransitions)) {
									return _Utils_Tuple2(
										_Utils_update(
									...
									var newAutomaton = _Utils_update(
										currentAutomaton,
										{
											transitions: _Utils_ap(
												...
												_List_fromArray(
													[
														{bend: oldBend, from: from, symbol: 'ε', to: to}
													]))
										});
									return _Utils_Tuple2(
										_Utils_update(
											model,
											{
												...
												consoleMessages: A2(
													$elm$core$List$cons,
													{msgType: $author$project$Components$Console$Info, text: t.editorTransitionAddedPrefix + 'ε'},
													model.consoleMessages),
												editingTransition: $elm$core$Maybe$Nothing,
												editingTransitionOldSymbol: $elm$core$Maybe$Nothing,
												selectedState: $elm$core$Maybe$Nothing,
							...
							var rawSymbols = A2(
								$elm$core$List$filter,
								A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
								A2($elm$core$String$split, ' ', newInput));
							...
							var uniqueSymbols = A2(
								$elm$core$List$filter,
								function (sym) {
									return !A4($author$project$Utils$AutomatonHelpers$transitionExists, from, to, sym, filteredTransitions);
								},
								symbols);
							var duplicates = A2(
								$elm$core$List$filter,
							...
							if (_Utils_eq(from, to) && A2($elm$core$List$member, 'ε', symbols)) {
								...
								if (!$elm$core$List$isEmpty(duplicates)) {
										...
										F2(
											function (symbol, acc) {
												return _Utils_ap(
													...
													_List_fromArray(
														[
															{bend: oldBend, from: from, symbol: symbol, to: to}
														]));
											}),
										filteredTransitions,
										uniqueSymbols);
									var newAutomaton = _Utils_update(
										currentAutomaton,
										{transitions: newTransitions});
									var addedCount = $elm$core$List$length(newTransitions) - $elm$core$List$length(filteredTransitions);
									var message = (addedCount === 1) ? _Utils_ap(
									...
									var newAutomaton = _Utils_update(
										currentAutomaton,
										{
											transitions: _Utils_ap(
												...
												_List_fromArray(
													[
														{bend: 0, from: from, symbol: 'ε', to: to}
													]))
										});
									return _Utils_Tuple2(
										_Utils_update(
										...
										F2(
											function (symbol, acc) {
												return _Utils_ap(
													...
													_List_fromArray(
														[
															{bend: 0, from: from, symbol: symbol, to: to}
														]));
											}),
										currentAutomaton.transitions,
										uniqueSymbols);
					...
					$elm$core$List$sort(
						A2(
							...
							A2(
								...
								currentAutomaton.transitions))));
				var _v28 = function () {
					var _v29 = _Utils_Tuple2(fromState, toState);
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								bendingTransition: $elm$core$Maybe$Just(
									{from: from, to: to}),
								isBending: false,
								isPanning: false
							}),
			...
			case 'StartArrowMouseDown':
				var stateId = msg.a;
				var x = msg.b;
				var y = msg.c;
				var _v32 = model.currentTool;
				if (_v32.$ === 'BuildTool') {
					var worldY = (y - model.panY) / model.zoom;
					var worldX = (x - model.panX) / model.zoom;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bendDragStartX: worldX,
								bendDragStartY: worldY,
								draggingStartArrow: $elm$core$Maybe$Just(stateId),
								isDraggingStartArrow: false,
								isPanning: false
							}),
						$elm$core$Platform$Cmd$none);
			...
			case 'ArrowRightClick':
				var from = msg.a;
				var to = msg.b;
				var _v33 = model.currentTool;
				if (_v33.$ === 'DeleteTool') {
					var newAutomaton = _Utils_update(
						currentAutomaton,
						{
						...
						$elm$core$List$sort(
							A2(
								...
								A2(
									...
									currentAutomaton.transitions))));
					var _v34 = function () {
						var _v35 = _Utils_Tuple2(fromState, toState);
						if ((_v35.a.$ === 'Just') && (_v35.b.$ === 'Just')) {
							var fs = _v35.a.a;
							var ts = _v35.b.a;
							return _Utils_eq(from, to) ? A3(
								$author$project$Pages$Editor$selfLoopPopupPos,
			...
			case 'RecenterCanvas':
				var cw = msg.a;
				var ch = msg.b;
				var targetState = function (ms) {
					if (ms.$ === 'Just') {
						var s = ms.a;
						return $elm$core$Maybe$Just(s);
					} else {
						return $elm$core$List$head(
							$elm$core$List$reverse(model.automaton.present.states));
					}
				}(
					$elm$core$List$head(
						A2(
				...
				if (targetState.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{panX: (cw / 2) - (s.x * model.zoom), panY: (ch / 2) - (s.y * model.zoom)}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Pages$Simulator$canStepForward = function (model) {
	if (model.efficientMode) {
		...
		var _v0 = model.mode;
		if (_v0.$ === 'DfaMode') {
			return (!$elm$core$String$isEmpty(model.remainingInput)) && _Utils_eq(model.verdict, $elm$core$Maybe$Nothing);
		} else {
			return A2(
				$elm$core$List$any,
				function (i) {
			...
			case 'RecenterCanvas':
				...
				var targetState = function (ms) {
					if (ms.$ === 'Just') {
						...
						return $elm$core$List$head(
							$elm$core$List$reverse(model.automaton.states));
					}
				}(
					$elm$core$List$head(
						A2(
				...
				switch (editorMsg.$) {
					...
					case 'SwitchToConversion':
						return _Utils_Tuple2(
							...
							$elm$core$Platform$Cmd$none);
					case 'SwitchToSimulator':
						var newTutorialStep = function () {
							var _v2 = model.tutorialStep;
							if ((_v2.$ === 'Just') && (_v2.a.$ === 'TutSimulateButton')) {
								var _v3 = _v2.a;
								return $elm$core$Maybe$Just($author$project$Main$TutEnterInput);
							} else {
								var other = _v2;
								return other;
							}
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{currentPage: $author$project$Main$SimulatorPage, simulatorModel: simulatorInit, tutorialStep: newTutorialStep}),
							$elm$core$Platform$Cmd$none);
					case 'ShareUrl':
					...
					case 'ToggleGridMode':
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{editorModel: newEditorModel, gridMode: newGrid}),
							$author$project$Main$saveGridMode(newGrid));
					case 'CopyDefinition':
						var t = $author$project$Utils$Translations$getTranslations(model.language);
						...
						var _v9 = A2($author$project$Pages$Editor$update, editorMsg, model.editorModel);
						var newEditorModel = _v9.a;
						var editorCmd = _v9.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
					...
					default:
						var _v10 = A2($author$project$Pages$Editor$update, editorMsg, model.editorModel);
						var newEditorModel = _v10.a;
						var editorCmd = _v10.b;
						var newTutorialStep = A2($author$project$Main$advanceTutorialEditor, model.tutorialStep, newEditorModel);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{editorModel: newEditorModel, tutorialStep: newTutorialStep}),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$EditorMsg, editorCmd));
				}
			case 'SimulatorMsg':
				...
				switch (simulatorMsg.$) {
					...
					default:
						...
						var shouldScrollTree = newSimulatorModel.showTree && (_Utils_eq(newSimulatorModel.mode, $author$project$Pages$Simulator$NfaMode) && function () {
							switch (simulatorMsg.$) {
								case 'StepForward':
									return true;
								case 'AutoStep':
						...
						var _v12 = A3($author$project$Main$advanceTutorialSimulator, model.tutorialStep, simulatorMsg, newSimulatorModel);
						var newTutorialStep = _v12.a;
						var tutorialCmd = _v12.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{simulatorModel: newSimulatorModel, tutorialStep: newTutorialStep}),
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										shouldScrollTree ? $author$project$Main$scrollToBottom('nfa-tree-scroll') : $elm$core$Platform$Cmd$none,
										tutorialCmd
									])));
				}
			case 'ConversionMsg':
			...
			case 'ToggleGridMode':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{editorModel: newEditorModel, gridMode: newGrid}),
					$author$project$Main$saveGridMode(newGrid));
			case 'TutorialWelcomeContinue':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tutorialStep: $elm$core$Maybe$Just($author$project$Main$TutToolbarUndoRedo)
						}),
					$elm$core$Platform$Cmd$none);
			case 'TutorialSkip':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tutorialStep: $elm$core$Maybe$Nothing}),
					$author$project$Main$saveTutorialSeen(_Utils_Tuple0));
			case 'TutorialNext':
				var nextStep = function () {
					var _v15 = model.tutorialStep;
					_v15$4:
					while (true) {
						if (_v15.$ === 'Just') {
							switch (_v15.a.$) {
								case 'TutToolbarUndoRedo':
									var _v16 = _v15.a;
									return $elm$core$Maybe$Just($author$project$Main$TutToolbarTools);
								case 'TutToolbarTools':
									var _v17 = _v15.a;
									return $elm$core$Maybe$Just($author$project$Main$TutToolbarFiles);
								case 'TutToolbarFiles':
									var _v18 = _v15.a;
									return $elm$core$Maybe$Just($author$project$Main$TutToolbarConvert);
								case 'TutToolbarConvert':
									var _v19 = _v15.a;
									return $elm$core$Maybe$Just($author$project$Main$TutCreateState1);
								default:
									break _v15$4;
							}
						} else {
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				var emptyAutomaton = {nextStateId: 0, states: _List_Nil, transitions: _List_Nil};
				var em = model.editorModel;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							editorModel: _Utils_update(
								em,
								{
									automaton: $elm_community$undo_redo$UndoList$fresh(emptyAutomaton)
								}),
							showGuide: false,
							tutorialStep: $elm$core$Maybe$Just($author$project$Main$TutToolbarUndoRedo)
						}),
...
var $author$project$Utils$Theme$darkTheme = {accentColor: '#00bcd4', acceptBorderColor: '#2e7d32', acceptFillColor: '#43a047', activeEdgeColor: '#e74c3c', automatonDefBorder: '#1976d2', automatonDefTitle: '#90caf9', automatonTypeDfa: '#4fc3f7', automatonTypeIncompleteDfa: '#ffd54f', automatonTypeNfa: '#ffa726', btnAutoRunActive: '#00897b', btnBuildActive: '#1976d2', btnConvert: '#7b1fa2', btnDelete: '#d32f2f', btnDisabledBg: '#455a64', btnDisabledText: '#607d8b', btnGuide: '#00897b', btnPrimary: '#0288d1', btnSecondaryBg: '#37474f', canvasBg: '#1a1f24', colorBlack: '#000', colorTransparent: 'transparent', colorWhite: 'white', consoleBg: '#0a0a0a', consoleHeaderBg: '#0d1a27', consoleText: '#d4d4d4', convSectionHeaderBg: '#1a1d35', convStepDescBg: '#2a2500', convTableCellHighlight: '#5a5000', convTableColHeaderHighlight: '#1a3a6a', convTableColHighlight: '#0d2a4a', convTableHeaderBg: '#37474f', convTableRowHighlight: '#4a4300', conversionNewFillColor: '#b3e5fc', conversionProcessedFillColor: '#cfd8dc', copyBtnBg: '#4a6a82', copyTooltipBg: '#333', dividerColor: '#37474f', edgeColor: '#cfd8dc', edgeLabelColor: '#ecf0f1', editingFillColor: '#ffe082', editingTextColor: '#1a1a1a', errorColor: '#F44336', errorColorDark: '#B71C1C', exampleCardBg: '#252d36', exampleCardBorder: '#2e3a47', gridStrokeColor: 'rgba(120,120,120,0.22)', highlightBorderColor: '#f57f17', highlightEdgeColor: '#f9a825', infoColor: '#2196F3', infoColorDark: '#1565C0', inputBg: '#252d36', inputBorder: '#455a64', inputText: '#ecf0f1', lightDividerBorder: '#e0e0e0', lightTextColor: '#222222', modalBg: '#1e2530', modalBorder: '#2e3a47', modalCodeBg: '#2a3340', modalCodeText: '#ef9a9a', modalErrorBg: '#2a1515', modalNoteBg: '#1b3a20', modalNoteText: '#a5d6a7', modalSectionTitle: '#4fc3f7', modalTabActiveBg: '#1e3040', modalTabActiveBorder: '#29b6f6', modalTabBg: '#161f28', modalText: '#b0bec5', mutedContrastText: '#cfd8dc', neutralGrayBg: '#90a4ae', neutralGrayStroke: '#607d8b', nfaNodeBoxBg: '#eceff1', nfaNodeBoxStroke: '#90a4ae', nfaNodeBoxText: '#37474f', overlayBorder: '#1565c0', overlayDark25: 'rgba(0,0,0,0.25)', overlayDark50: 'rgba(0,0,0,0.5)', overlayDark60: 'rgba(0,0,0,0.6)', overlayDark70: 'rgba(0,0,0,0.7)', overlayHint: '#78909c', overlayLight08: 'rgba(255,255,255,0.08)', overlayLight12: 'rgba(255,255,255,0.12)', overlayLight20: 'rgba(255,255,255,0.2)', overlayLight25: 'rgba(255,255,255,0.25)', overlayLight30: 'rgba(255,255,255,0.3)', overlayLight50: 'rgba(255,255,255,0.5)', readingHeadConsumedBg: '#2a3340', readingHeadConsumedText: '#546e7a', rejectBorderColor: '#b71c1c', rejectFillColor: '#e53935', relaunchBtnBg: '#00796b', resultAcceptBg: '#1b3a20', resultAcceptText: '#a5d6a7', resultRejectBg: '#2a1515', resultRejectText: '#ef9a9a', rightPanelBg: '#1e2530', rightPanelBorder: '#2a3845', runningBorderColor: '#1565c0', runningFillColor: '#1e88e5', selectedBorderColor: '#004d40', selectedFillColor: '#80cbc4', separatorColor: '#37474f', settingsBg: '#0d1a27', settingsBorder: '#1a2530', startArrowColor: '#64b5f6', stateBorder: '#cfd8dc', stateFill: '#2a3545', stateText: '#ecf0f1', stateTransitionHighlight: '#7a6000', strongBorderColor: '#0d1e30', successColor: '#4CAF50', successColorDark: '#2E7D32', tabActiveBg: '#2a3845', tabText: '#ecf0f1', textMuted: '#78909c', textOnDark: 'white', textPrimary: '#ecf0f1', textSecondary: '#b0bec5', toggleOffBg: '#546e7a', toggleOnBg: '#0288d1', toolbarBg: '#0d1a27', toolbarBorderColor: '#1a2530', toolbarDeleteBg: '#2a0d0d', trailAcceptFillColor: '#a5d6a7', trailRejectFillColor: '#ef9a9a', tutorialTooltipBg: '#263238', tutorialTooltipText: '#ffffff', tutorialVeilBg: 'rgba(0,0,0,0.55)', warningColor: '#f9a825', yellowGlowShadow: '0 0 0 3px #ffeb3b, 0 0 18px rgba(255,235,59,0.7)'};
var $author$project$Utils$Theme$lightTheme = {accentColor: '#00bcd4', acceptBorderColor: '#2e7d32', acceptFillColor: '#43a047', activeEdgeColor: '#e74c3c', automatonDefBorder: '#359ee4', automatonDefTitle: '#273646', automatonTypeDfa: '#358cc7', automatonTypeIncompleteDfa: '#d4a017', automatonTypeNfa: '#ec7c1a', btnAutoRunActive: '#00897b', btnBuildActive: '#1565c0', btnConvert: '#6a1b9a', btnDelete: '#c62828', btnDisabledBg: '#78909c', btnDisabledText: '#b0bec5', btnGuide: '#00796b', btnPrimary: '#0277bd', btnSecondaryBg: '#546e7a', canvasBg: '#ecf0f1', colorBlack: '#000', colorTransparent: 'transparent', colorWhite: 'white', consoleBg: '#000000', consoleHeaderBg: '#1a2f4a', consoleText: '#d4d4d4', convSectionHeaderBg: '#e8eaf6', convStepDescBg: '#fffde7', convTableCellHighlight: '#fff176', convTableColHeaderHighlight: '#90caf9', convTableColHighlight: '#e3f2fd', convTableHeaderBg: '#ccc', convTableRowHighlight: '#fff9c4', conversionNewFillColor: '#b3e5fc', conversionProcessedFillColor: '#cfd8dc', copyBtnBg: '#7aa8c7', copyTooltipBg: '#333', dividerColor: '#b0bec5', edgeColor: '#222', edgeLabelColor: 'black', editingFillColor: '#ffe082', editingTextColor: '#1a1a1a', errorColor: '#F44336', errorColorDark: '#B71C1C', exampleCardBg: '#fafafa', exampleCardBorder: '#cfd8dc', gridStrokeColor: 'rgba(120,120,120,0.22)', highlightBorderColor: '#f57f17', highlightEdgeColor: '#f9a825', infoColor: '#2196F3', infoColorDark: '#1565C0', inputBg: 'white', inputBorder: '#bdc3c7', inputText: '#212121', lightDividerBorder: '#e0e0e0', lightTextColor: '#222222', modalBg: 'white', modalBorder: '#cfd8dc', modalCodeBg: '#f5f5f5', modalCodeText: '#c62828', modalErrorBg: '#fff8f8', modalNoteBg: '#e8f5e9', modalNoteText: '#1b5e20', modalSectionTitle: '#1a2f4a', modalTabActiveBg: '#37474f', modalTabActiveBorder: '#4fc3f7', modalTabBg: '#263238', modalText: '#424242', mutedContrastText: '#cfd8dc', neutralGrayBg: '#90a4ae', neutralGrayStroke: '#607d8b', nfaNodeBoxBg: '#eceff1', nfaNodeBoxStroke: '#90a4ae', nfaNodeBoxText: '#37474f', overlayBorder: '#3498db', overlayDark25: 'rgba(0,0,0,0.25)', overlayDark50: 'rgba(0,0,0,0.5)', overlayDark60: 'rgba(0,0,0,0.6)', overlayDark70: 'rgba(0,0,0,0.7)', overlayHint: '#666', overlayLight08: 'rgba(255,255,255,0.08)', overlayLight12: 'rgba(255,255,255,0.12)', overlayLight20: 'rgba(255,255,255,0.2)', overlayLight25: 'rgba(255,255,255,0.25)', overlayLight30: 'rgba(255,255,255,0.3)', overlayLight50: 'rgba(255,255,255,0.5)', readingHeadConsumedBg: '#eceff1', readingHeadConsumedText: '#b0bec5', rejectBorderColor: '#b71c1c', rejectFillColor: '#e53935', relaunchBtnBg: '#00796b', resultAcceptBg: '#e8f5e9', resultAcceptText: '#2e7d32', resultRejectBg: '#ffebee', resultRejectText: '#c62828', rightPanelBg: '#f8f9fa', rightPanelBorder: '#34495e', runningBorderColor: '#1565c0', runningFillColor: '#1e88e5', selectedBorderColor: '#004d40', selectedFillColor: '#80cbc4', separatorColor: '#ccc', settingsBg: '#1e3a50', settingsBorder: '#263238', startArrowColor: '#1a6baa', stateBorder: '#455a64', stateFill: '#eceff1', stateText: '#000000', stateTransitionHighlight: '#fff59d', strongBorderColor: '#0d1e30', successColor: '#4CAF50', successColorDark: '#2E7D32', tabActiveBg: '#546e7a', tabText: 'white', textMuted: '#546e7a', textOnDark: 'white', textPrimary: '#212121', textSecondary: '#424242', toggleOffBg: '#546e7a', toggleOnBg: '#0288d1', toolbarBg: '#1a2f4a', toolbarBorderColor: '#263238', toolbarDeleteBg: '#4a1a1a', trailAcceptFillColor: '#a5d6a7', trailRejectFillColor: '#ef9a9a', tutorialTooltipBg: '#1e293b', tutorialTooltipText: '#ffffff', tutorialVeilBg: 'rgba(0,0,0,0.45)', warningColor: '#f9a825', yellowGlowShadow: '0 0 0 3px #ffeb3b, 0 0 18px rgba(255,235,59,0.7)'};
...
var $author$project$Main$tutorialHighlightForEditor = function (step) {
	_v0$5:
	while (true) {
		if (step.$ === 'Just') {
			switch (step.a.$) {
				case 'TutToolbarUndoRedo':
					var _v1 = step.a;
					return $elm$core$Maybe$Just('undoRedo');
				case 'TutToolbarTools':
					var _v2 = step.a;
					return $elm$core$Maybe$Just('tools');
				case 'TutToolbarFiles':
					var _v3 = step.a;
					return $elm$core$Maybe$Just('files');
				case 'TutToolbarConvert':
					var _v4 = step.a;
					return $elm$core$Maybe$Just('convert');
				case 'TutSimulateButton':
					var _v5 = step.a;
					return $elm$core$Maybe$Just('simulate');
				default:
					break _v0$5;
			}
		} else {
...
var $author$project$Components$Console$viewMessage = F3(
	function (theme, maybeOnLinkClick, message) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'border-top', '2px solid ' + config.theme.strongBorderColor)
			]),
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$core$List$map,
					A2($author$project$Components$Console$viewMessage, config.theme, config.onLinkClick),
...
var $author$project$Components$ConversionCanvas$viewCurvedEdge = F5(
	function (theme, a, b, symbols, isActive) {
		...
		var strokeColor = isActive ? theme.activeEdgeColor : theme.edgeColor;
		var spacing = 16;
		var r = 35.0;
...
var $author$project$Components$ConversionCanvas$startArrow = F3(
	function (theme, state, r) {
		if (!state.isStart) {
			...
			var contactAngle = $elm$core$Basics$degrees(180);
			var perpX = -$elm$core$Basics$sin(contactAngle);
			var perpY = $elm$core$Basics$cos(contactAngle);
			var tipX = state.x + (r * $elm$core$Basics$cos(contactAngle));
			var tipY = state.y + (r * $elm$core$Basics$sin(contactAngle));
			var color = theme.startArrowColor;
			var aw = 7;
			var arrowLen = 50;
			var lineX1 = state.x + ((r + arrowLen) * $elm$core$Basics$cos(contactAngle));
			var lineY1 = state.y + ((r + arrowLen) * $elm$core$Basics$sin(contactAngle));
			var al = 14;
			var baseX = tipX + (al * $elm$core$Basics$cos(contactAngle));
			var leftX = baseX + (aw * perpX);
			var rightX = baseX - (aw * perpX);
			var baseY = tipY + (al * $elm$core$Basics$sin(contactAngle));
			var leftY = baseY + (aw * perpY);
			var rightY = baseY - (aw * perpY);
			var pts = A2(
				$elm$core$String$join,
				' ',
				_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromFloat(lineY1)),
							$elm$svg$Svg$Attributes$x2(
							$elm$core$String$fromFloat(tipX)),
							$elm$svg$Svg$Attributes$y2(
							$elm$core$String$fromFloat(tipY)),
...
var $author$project$Components$ConversionCanvas$viewDfaState = F6(
	function (theme, onStateMouseDown, highlightId, newlyCreatedId, processedIds, state) {
		var r = 35;
		var isLightFill = _Utils_eq(
			newlyCreatedId,
			$elm$core$Maybe$Just(state.id)) || A2($elm$core$List$member, state.id, processedIds);
		var textColor = isLightFill ? theme.lightTextColor : theme.stateText;
		var isHighlighted = _Utils_eq(
			highlightId,
			$elm$core$Maybe$Just(state.id));
		var fillColor = _Utils_eq(
			newlyCreatedId,
			$elm$core$Maybe$Just(state.id)) ? theme.conversionNewFillColor : (A2($elm$core$List$member, state.id, processedIds) ? theme.conversionProcessedFillColor : theme.stateFill);
		var borderWidth = isHighlighted ? '3' : '2';
		var borderColor = isHighlighted ? theme.highlightBorderColor : theme.stateBorder;
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
...
var $author$project$Components$ConversionCanvas$wheelDeltaY = A2(
	$elm$json$Json$Decode$andThen,
	function (ctrlKey) {
		return ctrlKey ? $elm$json$Json$Decode$fail('pinch zoom') : A2($elm$json$Json$Decode$field, 'deltaY', $elm$json$Json$Decode$float);
	},
	A2($elm$json$Json$Decode$field, 'ctrlKey', $elm$json$Json$Decode$bool));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
	...
	function (t, nfaStates, dfaStates, step) {
		switch (step.$) {
			...
			case 'StepProcessSymbol':
				...
				return t.convProcessingPrefix + (srcLabel + (' so symbolom \'' + (info.symbol + (t.convMovePrefix + (moveStr + (t.convClosurePrefix + (destStr + (info.isNewState ? t.convNewStateCreated : t.convStateAlreadyExists))))))));
			case 'StepMarkProcessed':
				var info = step.a;
				return _Utils_ap(
...
var $author$project$Pages$Conversion$worktableCell = F8(
	function (theme, snap, isRowHighlighted, isProcessed, rowBg, highlightSymbol, stateId, sym) {
		...
		var cellBg = (isRowHighlighted && _Utils_eq(
			...
			highlightSymbol,
			$elm$core$Maybe$Just(sym)) ? theme.convTableColHighlight : theme.colorTransparent));
		return A2(
			$elm$html$Html$td,
			_List_fromArray(
				[
...
var $author$project$Pages$Conversion$viewWorktableRow = F6(
	function (theme, snap, alph, highlightStateId, highlightSymbol, state) {
		var isRowHighlighted = _Utils_eq(
			highlightStateId,
			$elm$core$Maybe$Just(state.id));
		var rowBg = isRowHighlighted ? theme.convTableRowHighlight : theme.colorTransparent;
		...
		return (!model.showSaveModal) ? A2($elm$html$Html$div, _List_Nil, _List_Nil) : A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayDark50),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'color',
					isEnabled ? theme.textOnDark : theme.btnDisabledText),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '5px'),
					A2(
					$elm$html$Html$Attributes$style,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'color',
					isDisabled ? theme.btnDisabledText : theme.textOnDark),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '5px'),
					A2(
					$elm$html$Html$Attributes$style,
...
var $author$project$Pages$Conversion$languageToggleBtn = F3(
	function (theme, t, onToggle) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(onToggle),
					A2($elm$html$Html$Attributes$style, 'background', theme.btnSecondaryBg),
					A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '4px'),
					A2($elm$html$Html$Attributes$style, 'padding', '2px 8px'),
...
var $author$project$Pages$Conversion$pillToggle = F3(
	function (theme, toggleMsg, isOn) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'background-color',
					isOn ? theme.toggleOnBg : theme.btnDisabledText),
					A2($elm$html$Html$Attributes$style, 'position', 'relative'),
					A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
					A2($elm$html$Html$Attributes$style, 'flex-shrink', '0'),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'background-color', theme.colorWhite),
							A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
						...
						[
							...
							_List_fromArray(
								[
									...
									A3($author$project$Pages$Conversion$pillToggle, theme, $author$project$Pages$Conversion$ToggleDarkMode, darkMode)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A3($author$project$Pages$Conversion$languageToggleBtn, theme, t, $author$project$Pages$Conversion$ToggleLanguage)
								]))
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayLight20),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Pages$Conversion$SwitchToEditor),
									A2($elm$html$Html$Attributes$style, 'padding', '11px 18px'),
							...
							_List_fromArray(
								[
									...
									_List_Nil),
									$elm$html$Html$text(t.backToEditor)
								])),
...
var $author$project$Pages$Editor$AddDeadState = {$: 'AddDeadState'};
var $author$project$Pages$Editor$ArrowMouseDown = F4(
	function (a, b, c, d) {
		return {$: 'ArrowMouseDown', a: a, b: b, c: c, d: d};
	});
var $author$project$Pages$Editor$ArrowRightClick = F2(
	function (a, b) {
		return {$: 'ArrowRightClick', a: a, b: b};
	});
...
var $author$project$Pages$Editor$RecenterCanvas = F2(
	function (a, b) {
		return {$: 'RecenterCanvas', a: a, b: b};
	});
...
var $author$project$Pages$Editor$StartArrowMouseDown = F3(
	function (a, b, c) {
		return {$: 'StartArrowMouseDown', a: a, b: b, c: c};
	});
...
var $author$project$Pages$Editor$StateRightClick = function (a) {
	return {$: 'StateRightClick', a: a};
};
...
var $author$project$Pages$Editor$ToggleGridMode = {$: 'ToggleGridMode'};
...
var $author$project$Pages$Editor$TransitionRightClick = F3(
	function (a, b, c) {
		return {$: 'TransitionRightClick', a: a, b: b, c: c};
	});
...
var $author$project$Components$AutomatonDisplay$viewWhyBlock = F3(
	function (theme, title, reasons) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'padding', '10px 0 6px 0')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Components$AutomatonDisplay$viewWhyNfaBlock = F4(
	function (theme, t, autoType, transitions) {
		switch (autoType.$) {
			case 'CompleteDFA':
				return $elm$html$Html$text('');
			case 'IncompleteDFA':
				return A3(
					$author$project$Components$AutomatonDisplay$viewWhyBlock,
					theme,
					t.simWhyIncompleteDfaTitle,
					_List_fromArray(
						[t.simWhyNfaIncomplete]));
			default:
				var hasNonDet = function () {
					var checkDups = F2(
						function (tl, seen) {
							checkDups:
							while (true) {
								if (!tl.b) {
									...
									var tr = tl.a;
									var rest = tl.b;
									var k = $elm$core$String$fromInt(tr.from) + ('|' + tr.symbol);
									if (A2($elm$core$List$member, k, seen)) {
										return true;
									} else {
										var $temp$tl = rest,
											$temp$seen = A2($elm$core$List$cons, k, seen);
										tl = $temp$tl;
										seen = $temp$seen;
										continue checkDups;
									}
				...
				var hasEpsilon = A2(
					...
					transitions);
				var reasons = _Utils_ap(
					hasEpsilon ? _List_fromArray(
						[t.simWhyNfaEpsilon]) : _List_Nil,
					hasNonDet ? _List_fromArray(
						[t.simWhyNfaNondet]) : _List_Nil);
				return A3($author$project$Components$AutomatonDisplay$viewWhyBlock, theme, t.simWhyNfaTitle, reasons);
		}
	});
var $author$project$Components$AutomatonDisplay$view = function (config) {
	var t = $author$project$Utils$Translations$getTranslations(config.language);
	var autoType = A2($author$project$Utils$AutomatonHelpers$classifyAutomaton, config.states, config.transitions);
	var typeColor = function () {
		switch (autoType.$) {
			case 'CompleteDFA':
				return config.theme.automatonTypeDfa;
			case 'IncompleteDFA':
				return config.theme.automatonTypeIncompleteDfa;
			default:
				return config.theme.automatonTypeNfa;
		}
	}();
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'flex-shrink', '0'),
						A2($elm$html$Html$Attributes$style, 'padding', '15px 15px 0 15px'),
						A2($elm$html$Html$Attributes$style, 'background-color', config.theme.rightPanelBg)
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												A2($elm$html$Html$Attributes$style, 'top', 'calc(100% + 6px)'),
												A2($elm$html$Html$Attributes$style, 'right', '0'),
												A2($elm$html$Html$Attributes$style, 'background', config.theme.copyTooltipBg),
												A2($elm$html$Html$Attributes$style, 'color', config.theme.textOnDark),
												A2($elm$html$Html$Attributes$style, 'padding', '3px 8px'),
												A2($elm$html$Html$Attributes$style, 'border-radius', '4px'),
												A2($elm$html$Html$Attributes$style, 'font-size', '11px'),
												A2($elm$html$Html$Attributes$style, 'white-space', 'nowrap'),
						...
						A4($author$project$Components$AutomatonDisplay$viewWhyNfaBlock, config.theme, t, autoType, config.transitions)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'flex', '1'),
						A2($elm$html$Html$Attributes$style, 'overflow-y', 'auto'),
						A2($elm$html$Html$Attributes$style, 'padding', '0 15px 15px 15px')
					]),
				_List_fromArray(
					[
...
var $author$project$Components$Canvas$svgGrid = function (config) {
	var strokeColor = config.theme.gridStrokeColor;
	var modFloat = F2(
		function (a, b) {
			return a - ($elm$core$Basics$floor(a / b) * b);
		});
	var gridSize = 60.0;
	var cellPx = gridSize * config.zoom;
	var cellStr = $elm$core$String$fromFloat(cellPx);
	var patX = A2(modFloat, config.panX, cellPx);
	var patY = A2(modFloat, config.panY, cellPx);
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$id('grid-bg'),
								$elm$svg$Svg$Attributes$x(
								$elm$core$String$fromFloat(patX)),
								$elm$svg$Svg$Attributes$y(
								$elm$core$String$fromFloat(patY)),
								$elm$svg$Svg$Attributes$width(cellStr),
								$elm$svg$Svg$Attributes$height(cellStr),
								A2($elm$html$Html$Attributes$attribute, 'patternUnits', 'userSpaceOnUse')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$svg$Svg$Attributes$x2(cellStr),
								...
								_List_fromArray(
									[
										...
										$elm$svg$Svg$Attributes$y2(cellStr),
										$elm$svg$Svg$Attributes$stroke(strokeColor),
										$elm$svg$Svg$Attributes$strokeWidth('1')
									]),
								_List_Nil)
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$width('100%'),
						$elm$svg$Svg$Attributes$height('100%'),
						$elm$svg$Svg$Attributes$fill('url(#grid-bg)')
					]),
				_List_Nil)
			]));
};
var $author$project$Components$Canvas$svgState = F2(
	function (config, state) {
		...
		var fillColor = function () {
			if (isSelected) {
				return config.theme.selectedFillColor;
			} else {
				if (isTransitionStart || isTransitionEnd) {
					return config.theme.stateTransitionHighlight;
				} else {
					if (isActive) {
						var _v2 = config.activeStateVerdict;
						if (_v2.$ === 'Nothing') {
							return config.theme.runningFillColor;
						} else {
							if (_v2.a) {
								return config.theme.acceptFillColor;
							} else {
								return config.theme.rejectFillColor;
							}
						}
					} else {
						if (isEditing) {
							return config.theme.editingFillColor;
						} else {
							if (highlightMatch.$ === 'Just') {
								var h = highlightMatch.a;
								return h.isAccepted ? config.theme.trailAcceptFillColor : config.theme.trailRejectFillColor;
							} else {
								return config.theme.stateFill;
							}
						}
					}
				}
		...
		var borderColor = function () {
			if (isSelected) {
				return config.theme.selectedBorderColor;
			} else {
				if (isActive) {
					var _v0 = config.activeStateVerdict;
					if (_v0.$ === 'Nothing') {
						return config.theme.runningBorderColor;
					} else {
						if (_v0.a) {
							return config.theme.acceptBorderColor;
						} else {
							return config.theme.rejectBorderColor;
						}
					}
				} else {
					if (isEditing) {
						return config.theme.highlightEdgeColor;
					} else {
						if (highlightMatch.$ === 'Just') {
							var h = highlightMatch.a;
							return h.isAccepted ? config.theme.acceptBorderColor : config.theme.rejectBorderColor;
						} else {
							return config.theme.stateBorder;
						}
					}
				}
			}
							...
							[
								...
								_List_fromArray(
									[
										...
										isEditing ? config.theme.editingTextColor : config.theme.stateText),
										$elm$svg$Svg$Attributes$fontWeight('bold'),
										$elm$svg$Svg$Attributes$style('user-select: none; pointer-events: none;')
									]),
								_List_fromArray(
									[
										$elm$svg$Svg$text(
										state.isCompact ? (A2($elm$core$String$left, 4, state.label) + '...') : state.label)
									]))
							]),
						function () {
							if (state.isStart) {
								var startArrowInteraction = config.isSimulateMode ? _List_Nil : _List_fromArray(
									[
										A2(
										$elm$svg$Svg$Events$custom,
										'mousedown',
										A3(
											...
											F2(
												function (x, y) {
													return {
														message: A3(config.onStartArrowMouseDown, state.id, x, y),
														preventDefault: false,
														stopPropagation: true
													};
												}),
											$author$project$Components$Canvas$offsetX,
											$author$project$Components$Canvas$offsetY)),
										$elm$svg$Svg$Attributes$style('cursor: grab;')
									]);
								var contactAngle = state.startAngle;
								var perpX = -$elm$core$Basics$sin(contactAngle);
								var perpY = $elm$core$Basics$cos(contactAngle);
								var tipX = state.x + (r * $elm$core$Basics$cos(contactAngle));
								var tipY = state.y + (r * $elm$core$Basics$sin(contactAngle));
								var color = config.theme.startArrowColor;
								var aw = 7;
								var arrowLen = 50;
								var lineX1 = state.x + ((r + arrowLen) * $elm$core$Basics$cos(contactAngle));
								var lineY1 = state.y + ((r + arrowLen) * $elm$core$Basics$sin(contactAngle));
										...
										_Utils_ap(
											_List_fromArray(
												[
													...
													$elm$svg$Svg$Attributes$y2(
													$elm$core$String$fromFloat(tipY)),
													$elm$svg$Svg$Attributes$stroke(config.theme.colorTransparent),
...
var $author$project$Components$Canvas$arrowInteractionAttrs = F3(
	function (config, fromId, toId) {
		return config.isSimulateMode ? _List_Nil : _List_fromArray(
			[
				A2(
				$elm$svg$Svg$Events$custom,
				'mousedown',
				A3(
					...
					F2(
						function (x, y) {
							return {
								message: A4(config.onArrowMouseDown, fromId, toId, x, y),
								preventDefault: false,
								stopPropagation: true
							};
						}),
				...
				$elm$json$Json$Decode$succeed(
					{
						message: A2(config.onArrowRightClick, fromId, toId),
						preventDefault: true,
						stopPropagation: true
					}))
			]);
	});
var $author$project$Components$Canvas$symLeftClickAttrs = F4(
	function (config, fromId, toId, sym) {
		return config.isSimulateMode ? _List_Nil : _List_fromArray(
			[
				A2(
				$elm$svg$Svg$Events$custom,
				...
				$elm$json$Json$Decode$succeed(
					{
						message: A3(config.onTransitionClick, fromId, toId, sym),
						preventDefault: false,
						stopPropagation: true
					}))
			]);
	});
var $author$project$Components$Canvas$symRightClickAttrs = F4(
	function (config, fromId, toId, sym) {
		return config.isSimulateMode ? _List_Nil : _List_fromArray(
			[
				A2(
				...
				$elm$json$Json$Decode$succeed(
					{
						message: A3(config.onTransitionRightClick, fromId, toId, sym),
						preventDefault: true,
						stopPropagation: true
					}))
			]);
	});
var $author$project$Components$Canvas$svgCurvedEdge = F8(
	function (config, a, b, symbols, bend, isActive, isHighlighted, highlightedSymbolsList) {
		var vy = b.y - a.y;
		var vx = b.x - a.x;
		var strokeWidth = isActive ? '4' : '2';
		var strokeColor = isActive ? config.theme.activeEdgeColor : (isHighlighted ? config.theme.highlightEdgeColor : config.theme.edgeColor);
		var spacing = 16;
		var r = 35;
		var offset = 40 + bend;
		var n = $elm$core$List$length(symbols);
		...
		var labels = _List_fromArray(
			[
				...
				A2(
					...
					F2(
						function (i, sym) {
							var sx2 = (i - ((n - 1) / 2.0)) * spacing;
							var labelColor = A2($elm$core$List$member, sym, highlightedSymbolsList) ? config.theme.highlightEdgeColor : config.theme.edgeLabelColor;
							return A2(
								$elm$svg$Svg$g,
								_Utils_ap(
									A4($author$project$Components$Canvas$symLeftClickAttrs, config, a.id, b.id, sym),
									A4($author$project$Components$Canvas$symRightClickAttrs, config, a.id, b.id, sym)),
								_List_fromArray(
									[
										A2(
										$elm$svg$Svg$rect,
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							A3($author$project$Components$Canvas$arrowInteractionAttrs, config, a.id, b.id)),
						_List_Nil),
						A2(
						$elm$svg$Svg$polygon,
						_List_fromArray(
...
var $author$project$Components$Canvas$svgBentEdge = function (config) {
	return function (a) {
		return function (b) {
								...
								return function (uy) {
									return function (isActive) {
										return function (isHighlighted) {
											return function (highlightedSymbolsList) {
												var strokeWidth = isActive ? '4' : '2';
												var strokeColor = isActive ? config.theme.activeEdgeColor : (isHighlighted ? config.theme.highlightEdgeColor : config.theme.edgeColor);
												var spacing = 16;
												var r = 35;
...
var $author$project$Components$Canvas$svgEdge = F8(
	function (config, a, b, symbols, bend, isActive, isHighlighted, highlightedSymbolsList) {
		var vy = b.y - a.y;
		var vx = b.x - a.x;
		var r = 35;
		...
		if (!bend) {
			...
			return $author$project$Components$Canvas$svgBentEdge(config)(a)(b)(symbols)(bend)(px)(py)(ux)(uy)(isActive)(isHighlighted)(highlightedSymbolsList);
		}
	});
var $author$project$Components$Canvas$svgSelfLoop = F7(
	function (config, state, symbols, bend, isActive, isHighlighted, highlightedSymbolsList) {
		var strokeWidth = isActive ? '4' : '2';
		var strokeColor = isActive ? config.theme.activeEdgeColor : (isHighlighted ? config.theme.highlightEdgeColor : config.theme.edgeColor);
		var r = 35;
		var midAngle = bend - ($elm$core$Basics$pi / 2);
		var outX = $elm$core$Basics$cos(midAngle);
		var outY = $elm$core$Basics$sin(midAngle);
		var loopHeight = 55;
		var peakX = state.x + (((r + loopHeight) + 12) * $elm$core$Basics$cos(midAngle));
		var peakY = state.y + (((r + loopHeight) + 12) * $elm$core$Basics$sin(midAngle));
		var labels = function () {
			var symbolStyle = config.isSimulateMode ? 'user-select: none; pointer-events: none;' : 'user-select: none;';
			var spacing = 16;
			var n = $elm$core$List$length(symbols);
			var labelStartX = peakX - (((n - 1) * spacing) / 2);
			return A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, sym) {
						var lx = labelStartX + (i * spacing);
						var labelColor = A2($elm$core$List$member, sym, highlightedSymbolsList) ? config.theme.highlightEdgeColor : config.theme.edgeLabelColor;
						return A2(
							$elm$svg$Svg$g,
							_Utils_ap(
								A4($author$project$Components$Canvas$symLeftClickAttrs, config, state.id, state.id, sym),
								A4($author$project$Components$Canvas$symRightClickAttrs, config, state.id, state.id, sym)),
							_List_fromArray(
								[
									A2(
									$elm$svg$Svg$rect,
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$x(
											$elm$core$String$fromFloat(lx - 12)),
											$elm$svg$Svg$Attributes$y(
											$elm$core$String$fromFloat(peakY - 10)),
											$elm$svg$Svg$Attributes$width('24'),
											$elm$svg$Svg$Attributes$height('20'),
											$elm$svg$Svg$Attributes$fill(config.theme.colorTransparent),
											$elm$svg$Svg$Attributes$style('cursor: pointer;')
									...
									_List_fromArray(
										[
											$elm$svg$Svg$Attributes$x(
											$elm$core$String$fromFloat(lx)),
											$elm$svg$Svg$Attributes$y(
											$elm$core$String$fromFloat(peakY + 5)),
											$elm$svg$Svg$Attributes$textAnchor('middle'),
											$elm$svg$Svg$Attributes$fontSize('16'),
											$elm$svg$Svg$Attributes$fill(labelColor),
											$elm$svg$Svg$Attributes$fontWeight('bold'),
		...
		var halfAperture = $elm$core$Basics$pi / 3;
		var startAngle = midAngle - halfAperture;
		var sx = state.x + (r * $elm$core$Basics$cos(startAngle));
		var sy = state.y + (r * $elm$core$Basics$sin(startAngle));
		var endAngle = midAngle + halfAperture;
		var ex = state.x + (r * $elm$core$Basics$cos(endAngle));
		var ey = state.y + (r * $elm$core$Basics$sin(endAngle));
		var c2y = ey + (loopHeight * outY);
		var c2x = ex + (loopHeight * outX);
		var c1y = sy + (loopHeight * outY);
		var c1x = sx + (loopHeight * outX);
		...
		var avy = ey - c2y;
		var avx = ex - c2x;
		var alen = $elm$core$Basics$sqrt((avx * avx) + (avy * avy));
		var aux = (!alen) ? 1 : (avx / alen);
		var auy = (!alen) ? 0 : (avy / alen);
		var arrowPts = A4($author$project$Utils$AutomatonHelpers$calculateArrowHead, ex, ey, aux, auy);
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
			_Utils_ap(
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							A3($author$project$Components$Canvas$arrowInteractionAttrs, config, state.id, state.id)),
						_List_Nil),
						A2(
						$elm$svg$Svg$polygon,
						_List_fromArray(
...
var $author$project$Components$Canvas$viewGroupedTransition = F2(
	function (config, grouped) {
		...
		var isHighlighted = A2(
			$elm$core$List$any,
			function (ht) {
				return _Utils_eq(ht.from, grouped.from) && _Utils_eq(ht.to, grouped.to);
			},
			config.highlightedTransitions);
		var isActive = function () {
		...
		var highlightedSymbolsForGroup = A2(
			$elm$core$List$map,
			function ($) {
				return $.symbol;
			},
			A2(
				$elm$core$List$filter,
				function (hs) {
					return _Utils_eq(hs.from, grouped.from) && _Utils_eq(hs.to, grouped.to);
				},
		...
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			...
			var toState = _v0.b.a;
			return _Utils_eq(fromState.id, toState.id) ? A7($author$project$Components$Canvas$svgSelfLoop, config, fromState, grouped.symbols, grouped.bend, isActive, isHighlighted, highlightedSymbolsForGroup) : (hasReverseTransition ? A8($author$project$Components$Canvas$svgCurvedEdge, config, fromState, toState, grouped.symbols, grouped.bend, isActive, isHighlighted, highlightedSymbolsForGroup) : A8($author$project$Components$Canvas$svgEdge, config, fromState, toState, grouped.symbols, grouped.bend, isActive, isHighlighted, highlightedSymbolsForGroup));
		} else {
			return A2($elm$svg$Svg$g, _List_Nil, _List_Nil);
		}
	});
var $author$project$Components$Canvas$wheelDeltaY = A2(
	$elm$json$Json$Decode$andThen,
	function (ctrlKey) {
		return ctrlKey ? $elm$json$Json$Decode$fail('pinch zoom') : A2($elm$json$Json$Decode$field, 'deltaY', $elm$json$Json$Decode$float);
	},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					config.gridMode ? _List_fromArray(
						[
							$author$project$Components$Canvas$svgGrid(config)
						]) : _List_Nil,
					_List_fromArray(
						[
							A2(
...
var $author$project$Components$Toolbar$actionButton = F8(
	function (theme, label, onClickMsg, isEnabled, disabledReason, onDisabledClick, bgColor, isHighlighted) {
		var _v0 = function () {
			if (isEnabled) {
		...
		return A2(
			...
			_Utils_ap(
				...
				isHighlighted ? _List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'position', 'relative'),
						A2($elm$html$Html$Attributes$style, 'z-index', '501'),
						A2($elm$html$Html$Attributes$style, 'box-shadow', theme.yellowGlowShadow)
					]) : _List_Nil),
			_List_fromArray(
				[
					$elm$html$Html$text(label)
...
var $author$project$Components$Toolbar$btnGroup = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayDark25),
					A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
...
var $author$project$Components$Toolbar$buildToolIcon = A2(
	$elm$html$Html$img,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$src('icons/build.svg'),
			$elm$html$Html$Attributes$width(18),
			$elm$html$Html$Attributes$height(18)
		]),
	_List_Nil);
var $author$project$Components$Toolbar$deadStateButtonGroup = F2(
	function (config, t) {
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'background-color',
						config.isAddDeadStateEnabled ? config.theme.btnConvert : config.theme.btnDisabledBg),
						A2(
						$elm$html$Html$Attributes$style,
						'color',
						config.isAddDeadStateEnabled ? config.theme.textOnDark : config.theme.btnDisabledText),
						A2($elm$html$Html$Attributes$style, 'border', 'none'),
						A2($elm$html$Html$Attributes$style, 'border-radius', '5px'),
						A2(
						$elm$html$Html$Attributes$style,
						'cursor',
						config.isAddDeadStateEnabled ? 'pointer' : 'not-allowed'),
						A2($elm$html$Html$Attributes$style, 'font-size', '14px'),
						A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
						A2($elm$html$Html$Attributes$style, 'display', 'flex'),
						A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
						A2($elm$html$Html$Attributes$style, 'gap', '6px'),
						$elm$html$Html$Attributes$disabled(!config.isAddDeadStateEnabled),
						$elm$html$Html$Attributes$title(
						config.isAddDeadStateEnabled ? config.addDeadStateInfoTooltip : '')
					]),
				config.isAddDeadStateEnabled ? _List_fromArray(
					[
						$elm$html$Html$Events$onClick(config.onAddDeadState)
					]) : _List_Nil),
			_List_fromArray(
				[
					$elm$html$Html$text(t.editorAddDeadState),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'height', '16px'),
							A2($elm$html$Html$Attributes$style, 'border-radius', '50%'),
							A2($elm$html$Html$Attributes$style, 'background-color', config.theme.overlayLight25),
							A2($elm$html$Html$Attributes$style, 'font-size', '11px'),
							A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
							A2($elm$html$Html$Attributes$style, 'display', 'flex'),
							A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
...
var $author$project$Components$Toolbar$deleteToolIcon = A2(
	$elm$html$Html$img,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$src('icons/delete.svg'),
			$elm$html$Html$Attributes$width(18),
			$elm$html$Html$Attributes$height(18)
		]),
	_List_Nil);
...
var $author$project$Components$Toolbar$highlightWrap = F3(
	function (theme, isHighlighted, inner) {
...
var $author$project$Components$Toolbar$iconTextBtn = F7(
	function (theme, icon, label, onClickMsg, isDisabled, tipText, compact) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
			...
			compact ? _List_fromArray(
				[icon]) : _List_fromArray(
				[
					icon,
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('toolbar-btn-label')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(label)
...
var $author$project$Components$Toolbar$saveIcon = A2(
	...
	_List_Nil);
var $author$project$Components$Toolbar$languageToggleBtn = F3(
	function (theme, t, onToggle) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
...
var $author$project$Components$Toolbar$pillToggle = F3(
	function (theme, onToggle, isOn) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'background-color',
					isOn ? theme.toggleOnBg : theme.toggleOffBg),
					A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
					A2($elm$html$Html$Attributes$style, 'position', 'relative'),
					A2($elm$html$Html$Attributes$style, 'transition', 'background-color 0.2s'),
					A2($elm$html$Html$Attributes$style, 'flex-shrink', '0')
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'z-index', '2000'),
						A2($elm$html$Html$Attributes$style, 'min-width', '180px'),
						A2($elm$html$Html$Attributes$style, 'box-shadow', '0 4px 16px ' + config.theme.overlayDark50)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'color', config.theme.mutedContrastText),
										A2($elm$html$Html$Attributes$style, 'font-size', '13px')
									]),
								_List_fromArray(
									[
								...
								A3($author$project$Components$Toolbar$pillToggle, config.theme, config.onToggleDarkMode, config.darkMode)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A3($author$project$Components$Toolbar$languageToggleBtn, config.theme, t, config.onToggleLanguage)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(t.gridMode)
									])),
								A3($author$project$Components$Toolbar$pillToggle, config.theme, config.onToggleGridMode, config.gridMode)
							]))
					])) : $elm$html$Html$text('')
			]));
};
var $author$project$Components$Toolbar$shareIcon = A2(
	...
	_List_Nil);
var $author$project$Components$Toolbar$toolBtn = F8(
	function (theme, label, onClickMsg, isActive, shortcut, activeColor, maybeIcon, compact) {
		...
		return A2(
			...
			function () {
				var _v0 = _Utils_Tuple2(compact, maybeIcon);
				if (_v0.a && (_v0.b.$ === 'Just')) {
					var icon = _v0.b.a;
					return _List_fromArray(
						[icon]);
...
var $author$project$Components$Toolbar$view = function (config) {
	var t = $author$project$Utils$Translations$getTranslations(config.language);
	var compactTools = config.windowWidth < 1250;
	var compactFiles = config.windowWidth < 1540;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(
				$author$project$Components$Toolbar$highlightWrap,
				config.theme,
				_Utils_eq(
					config.tutorialHighlightGroup,
					$elm$core$Maybe$Just('undoRedo')),
				A2(
					$author$project$Components$Toolbar$btnGroup,
					config.theme,
					_List_fromArray(
						[
							A7($author$project$Components$Toolbar$iconTextBtn, config.theme, $author$project$Components$Toolbar$resetIcon, t.reset, config.onResetTool, false, t.reset, false),
				...
				A2(
					...
					_List_fromArray(
						[
							A8(
							$author$project$Components$Toolbar$toolBtn,
							config.theme,
							t.build,
							config.onBuildTool,
							config.currentTool === 'BuildTool',
							'Shift+B',
							config.theme.btnBuildActive,
							$elm$core$Maybe$Just($author$project$Components$Toolbar$buildToolIcon),
							compactTools),
							A8(
							$author$project$Components$Toolbar$toolBtn,
							config.theme,
							t._delete,
							config.onDeleteTool,
							config.currentTool === 'DeleteTool',
							'Shift+D',
							config.theme.btnDelete,
							$elm$core$Maybe$Just($author$project$Components$Toolbar$deleteToolIcon),
							compactTools)
						]))),
				A3(
				$author$project$Components$Toolbar$highlightWrap,
				...
				A2(
					...
					_List_fromArray(
						[
							A7($author$project$Components$Toolbar$iconTextBtn, config.theme, $author$project$Components$Toolbar$exportIcon, t._export, config.onExport, false, t.exportTooltip, compactFiles),
							A7($author$project$Components$Toolbar$iconTextBtn, config.theme, $author$project$Components$Toolbar$saveIcon, t.save, config.onSave, false, t.saveTooltip, compactFiles),
							A7($author$project$Components$Toolbar$iconTextBtn, config.theme, $author$project$Components$Toolbar$loadIcon, t.load, config.onLoad, false, t.loadTooltip, compactFiles),
							A7($author$project$Components$Toolbar$iconTextBtn, config.theme, $author$project$Components$Toolbar$shareIcon, t.shareViaUrl, config.onShare, false, t.shareViaUrlTooltip, compactFiles)
						]))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'background-color', config.theme.overlayLight20),
						A2($elm$html$Html$Attributes$style, 'margin', '0 4px')
					]),
				_List_Nil),
				A3(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							false),
							A2($author$project$Components$Toolbar$deadStateButtonGroup, config, t)
						]))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
...
var $author$project$Pages$Editor$viewInlineTransitionInput = F4(
	function (theme, t, canvasW, model) {
		var _v0 = model.editingTransition;
		if (_v0.$ === 'Just') {
			var x = _v0.a.x;
			var y = _v0.a.y;
			var stateR = 35 * model.zoom;
			var screenY = (y * model.zoom) + model.panY;
			var screenX = (x * model.zoom) + model.panX;
			var popupW = 195;
			var popupLeft = ((screenX - (popupW / 2)) < 0) ? (screenX + stateR) : ((_Utils_cmp(screenX + (popupW / 2), canvasW) > 0) ? ((screenX - stateR) - popupW) : (screenX - (popupW / 2)));
			var popupH = 70;
			var popupTop = (((screenY - stateR) - popupH) < 0) ? ((screenY + stateR) + 5) : (((screenY - stateR) - popupH) - 5);
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'left',
						$elm$core$String$fromFloat(popupLeft) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'top',
						$elm$core$String$fromFloat(popupTop) + 'px'),
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($elm$html$Html$Attributes$style, 'padding', '5px 7px'),
										A2($elm$html$Html$Attributes$style, 'border', 'none'),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Pages$Editor$ConfirmTransitionSymbol),
...
var $author$project$Pages$Editor$SetStateModalIsCompact = function (a) {
	return {$: 'SetStateModalIsCompact', a: a};
};
...
var $author$project$Pages$Editor$viewStateModal = F4(
	function (theme, t, canvasW, model) {
		...
		if (_v0.$ === 'Just') {
			...
			if (maybeState.$ === 'Just') {
				...
				var modalW = 240;
				var modalLeft = ((screenX - (modalW / 2)) < 0) ? (screenX + stateR) : ((_Utils_cmp(screenX + (modalW / 2), canvasW) > 0) ? ((screenX - stateR) - modalW) : (screenX - (modalW / 2)));
				var modalH = 200;
				var modalTop = (((screenY - stateR) - modalH) < 0) ? ((screenY + stateR) + 5) : (((screenY - stateR) - modalH) - 5);
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'left',
							$elm$core$String$fromFloat(modalLeft) + 'px'),
							A2(
							$elm$html$Html$Attributes$style,
							'top',
							$elm$core$String$fromFloat(modalTop) + 'px'),
							A2($elm$html$Html$Attributes$style, 'z-index', '1000'),
							A2($elm$html$Html$Attributes$style, 'background-color', theme.inputBg),
							A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + theme.overlayBorder),
							A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
					...
					_List_fromArray(
						[
							...
							(($elm$core$String$length(model.stateLabelInput) * 8) > 60) ? A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$type_('checkbox'),
											$elm$html$Html$Attributes$id('modal-compact-cb'),
											$elm$html$Html$Attributes$checked(model.stateModalIsCompact),
											$elm$html$Html$Events$onCheck($author$project$Pages$Editor$SetStateModalIsCompact)
										]),
									_List_Nil),
									A2(
									$elm$html$Html$label,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$for('modal-compact-cb'),
											A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
											A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
											A2($elm$html$Html$Attributes$style, 'color', theme.textPrimary)
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(t.editorCompactStateCheckbox)
										]))
								])) : A2($elm$html$Html$div, _List_Nil, _List_Nil),
							A2(
							$elm$html$Html$div,
...
var $author$project$Pages$Editor$view = F8(
	function (consoleOpen, darkMode, settingsOpen, language, windowWidth, windowHeight, tutorialHighlightGroup, model) {
		var theme = $author$project$Utils$Theme$getTheme(darkMode);
		var t = $author$project$Utils$Translations$getTranslations(language);
		var canvasW = windowWidth - 302;
		var canvasH = windowHeight - 80;
		...
		var autoType = A2($author$project$Utils$AutomatonHelpers$classifyAutomaton, states, transitions);
		var convertDisabledReason = $elm$core$List$isEmpty(states) ? $elm$core$Maybe$Just(t.editorAddStateRequirement) : ((!hasStart) ? $elm$core$Maybe$Just(t.editorStartStateRequirement) : ((!hasEnd) ? $elm$core$Maybe$Just(t.editorEndStateRequirement) : (_Utils_eq(autoType, $author$project$Shared$CompleteDFA) ? $elm$core$Maybe$Just(t.editorConvertRequirement) : (_Utils_eq(autoType, $author$project$Shared$IncompleteDFA) ? $elm$core$Maybe$Just(t.editorConvertRequirementIncomplete) : $elm$core$Maybe$Nothing))));
		var isConvertEnabled = (!$elm$core$List$isEmpty(states)) && (hasStart && (hasEnd && _Utils_eq(autoType, $author$project$Shared$NFA)));
		var problematicSymbols = function () {
			if (_Utils_eq(autoType, $author$project$Shared$CompleteDFA)) {
				return _List_Nil;
			} else {
				var nonDetSymbols = A2(
					$elm$core$List$map,
					function (tr) {
						return {from: tr.from, symbol: tr.symbol, to: tr.to};
					},
					A2(
						$elm$core$List$filter,
						function (tr) {
							return $elm$core$List$length(
								A2(
									$elm$core$List$filter,
									function (t2) {
										return _Utils_eq(t2.from, tr.from) && _Utils_eq(t2.symbol, tr.symbol);
									},
									transitions)) > 1;
						},
						A2(
				...
				var epsSymbols = A2(
					...
					A2(
						...
						transitions));
				return _Utils_ap(nonDetSymbols, epsSymbols);
			}
		}();
		var problematicTransitions = function () {
			if (_Utils_eq(autoType, $author$project$Shared$CompleteDFA)) {
				return _List_Nil;
			} else {
				var nonDetKeys = A2(
				...
				var epsHighlights = A2(
					...
					A2(
						...
						transitions));
				return _Utils_ap(nonDetKeys, epsHighlights);
			}
		}();
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Components$Toolbar$view(
							{
								...
								isAddDeadStateEnabled: _Utils_eq(autoType, $author$project$Shared$IncompleteDFA),
								isConvertEnabled: isConvertEnabled,
								isSimulateEnabled: isSimulateEnabled,
								language: language,
								onAddDeadState: $author$project$Pages$Editor$AddDeadState,
								...
								onToggleGridMode: $author$project$Pages$Editor$ToggleGridMode,
							...
							var targetState = function (ms) {
								...
								$elm$core$List$head(
									A2(
										...
										states)));
							var targetVisible = function () {
								if (targetState.$ === 'Just') {
									var s = targetState.a;
									var sy = (s.y * model.zoom) + model.panY;
									var sx = (s.x * model.zoom) + model.panX;
									return (_Utils_cmp(sx, -35) > -1) && ((_Utils_cmp(sx, canvasW + 35) < 1) && ((_Utils_cmp(sy, -35) > -1) && (_Utils_cmp(sy, canvasH + 35) < 1)));
								} else {
									return true;
								}
							}();
								...
								_List_fromArray(
									[
										$author$project$Components$Canvas$view(
										{
											...
											onArrowMouseDown: $author$project$Pages$Editor$ArrowMouseDown,
											onArrowRightClick: $author$project$Pages$Editor$ArrowRightClick,
											...
											onStartArrowMouseDown: $author$project$Pages$Editor$StartArrowMouseDown,
											...
											onStateRightClick: $author$project$Pages$Editor$StateRightClick,
											onTransitionClick: $author$project$Pages$Editor$TransitionClick,
											onTransitionRightClick: $author$project$Pages$Editor$TransitionRightClick,
											onWheel: F3(
												function (d, x, y) {
										...
										_Utils_ap(
											...
											targetVisible ? _List_fromArray(
												[
													$elm$html$Html$Attributes$disabled(true)
												]) : _List_fromArray(
												[
													$elm$html$Html$Events$onClick(
													A2($author$project$Pages$Editor$RecenterCanvas, canvasW, canvasH))
												])),
										_List_fromArray(
											[
												$elm$html$Html$text(t.editorRecenter)
											]))
									]));
						}(),
							A2(
					...
					A4($author$project$Pages$Editor$viewInlineTransitionInput, theme, t, canvasW, model),
					A4($author$project$Pages$Editor$viewStateModal, theme, t, canvasW, model),
...
var $author$project$Pages$Simulator$RecenterCanvas = F2(
	function (a, b) {
		return {$: 'RecenterCanvas', a: a, b: b};
	});
	...
	function (config, displayIdx, instance) {
		...
		var _v0 = function () {
			...
			if (_v1.$ === 'Nothing') {
				return _Utils_Tuple3(
					t.running,
					config.theme.infoColor,
					isSelected ? config.theme.infoColorDark : config.theme.infoColor);
			} else {
				var v = _v1.a;
				return v.isAccepted ? _Utils_Tuple3(
					t.accepted,
					config.theme.successColor,
					isSelected ? config.theme.successColorDark : config.theme.successColor) : _Utils_Tuple3(
					t.rejected,
					config.theme.errorColor,
					isSelected ? config.theme.errorColorDark : config.theme.errorColor);
			}
		}();
...
var $author$project$Components$SimulateToolbar$autoRunButton = F5(
	function (theme, t, onToggle, running, isHighlighted) {
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				_List_fromArray(
...
var $author$project$Components$SimulateToolbar$resetIcon = A2(
	...
	_List_Nil);
var $author$project$Components$SimulateToolbar$languageToggleBtn = F3(
	function (theme, t, onToggle) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
...
var $author$project$Components$SimulateToolbar$pillToggle = F3(
	function (theme, onToggle, isOn) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($author$project$Components$SimulateToolbar$pillToggle, config.theme, config.onToggleDarkMode, config.darkMode)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A3($author$project$Components$SimulateToolbar$languageToggleBtn, config.theme, t, config.onToggleLanguage)
							]))
					])) : $elm$html$Html$text('')
			]));
};
...
var $author$project$Components$SimulateToolbar$toolButton = F6(
	function (theme, label, onClickMsg, isEnabled, isActive, isHighlighted) {
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A6($author$project$Components$SimulateToolbar$toolButton, config.theme, t.stepBack, config.onStepBackward, config.canStepBackward, false, false),
				A6(
				...
				A5($author$project$Components$SimulateToolbar$autoRunButton, config.theme, t, config.onToggleAutoRun, config.autoRunning, config.tutorialHighlightButtons),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$max('4000'),
								...
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
								A2($elm$html$Html$Attributes$style, 'accent-color', config.theme.accentColor)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(config.onSwitchToEditor),
								A2($elm$html$Html$Attributes$style, 'padding', '11px 18px'),
								A2($elm$html$Html$Attributes$style, 'background-color', config.theme.btnPrimary),
								A2($elm$html$Html$Attributes$style, 'color', config.theme.textOnDark),
								A2($elm$html$Html$Attributes$style, 'border', 'none'),
								A2($elm$html$Html$Attributes$style, 'border-radius', '5px'),
								A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
...
var $author$project$Pages$Simulator$viewDisabledToggleTab = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background-color', theme.colorTransparent),
					A2($elm$html$Html$Attributes$style, 'color', theme.textMuted),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
...
var $author$project$Components$NfaTreeView$view = function (config) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$stroke(config.theme.neutralGrayBg),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$fill(config.theme.nfaNodeBoxBg),
								$elm$svg$Svg$Attributes$stroke(config.theme.nfaNodeBoxStroke),
								$elm$svg$Svg$Attributes$strokeWidth('1')
							]),
						_List_Nil),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$fill(config.theme.nfaNodeBoxText),
								$elm$svg$Svg$Attributes$fontSize('11'),
								$elm$svg$Svg$Attributes$fontWeight('bold'),
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$y2(
						$elm$core$String$fromFloat(childPos.y - $author$project$Components$NfaTreeView$nodeR)),
						$elm$svg$Svg$Attributes$stroke(config.theme.dividerColor),
						$elm$svg$Svg$Attributes$strokeWidth('1.5')
					]),
				_List_Nil);
		});
	...
	var nodeColors = function (nid) {
		...
		if (_v8.$ === 'Nothing') {
			return {fill: config.theme.neutralGrayBg, stroke: config.theme.neutralGrayStroke, textFill: config.theme.textOnDark};
		} else {
			var inst = _v8.a;
			var _v9 = inst.verdict;
			if (_v9.$ === 'Nothing') {
				return {fill: config.theme.runningFillColor, stroke: config.theme.runningBorderColor, textFill: config.theme.textOnDark};
			} else {
				var v = _v9.a;
				return v.isAccepted ? {fill: config.theme.acceptFillColor, stroke: config.theme.acceptBorderColor, textFill: config.theme.textOnDark} : {fill: config.theme.rejectFillColor, stroke: config.theme.rejectBorderColor, textFill: config.theme.textOnDark};
			}
		}
	};
	var renderNode = F3(
		function (pos, label, selectMsg) {
			...
			var strokeColor = isSelected(pos.id) ? config.theme.textOnDark : colors.stroke;
			return A2(
				$elm$svg$Svg$g,
				_List_fromArray(
					[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$y2(
								$elm$core$String$fromFloat(y - ($author$project$Components$NfaTreeView$levelH / 2))),
								$elm$svg$Svg$Attributes$stroke(config.theme.mutedContrastText),
								$elm$svg$Svg$Attributes$strokeWidth('1'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('nfa-tree-scroll'),
						A2($elm$html$Html$Attributes$style, 'width', '100%'),
						A2($elm$html$Html$Attributes$style, 'height', '100%'),
...
var $author$project$Pages$Simulator$viewReadingHead = F4(
	function (theme, alphabet, fullInput, remaining) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'background-color',
							(isCurrent && isUnknown) ? theme.warningColor : (isCurrent ? theme.runningFillColor : (isConsumed ? theme.readingHeadConsumedBg : (isUnknown ? theme.warningColor : theme.inputBg)))),
							A2(
							$elm$html$Html$Attributes$style,
							'color',
							(isCurrent && isUnknown) ? theme.colorBlack : (isCurrent ? theme.textOnDark : (isConsumed ? theme.readingHeadConsumedText : (isUnknown ? theme.colorBlack : theme.inputText)))),
							A2(
							$elm$html$Html$Attributes$style,
							'border',
							isCurrent ? ('2px solid ' + theme.runningBorderColor) : (isUnknown ? ('1px solid ' + theme.highlightBorderColor) : ('1px solid ' + theme.inputBorder))),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'background-color',
					isActive ? theme.tabActiveBg : theme.colorTransparent),
					A2($elm$html$Html$Attributes$style, 'color', theme.tabText),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
					A2(
					$elm$html$Html$Attributes$style,
					'border-bottom',
					isActive ? ('2px solid ' + theme.accentColor) : ('2px solid ' + theme.colorTransparent)),
					A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
					A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
					A2(
					$elm$html$Html$Attributes$style,
...
var $author$project$Pages$Simulator$viewWhyNfaBlock = F5(
	function (theme, t, autoType, hasEpsilon, hasNonDeterminism) {
		var title = function () {
			if (autoType.$ === 'IncompleteDFA') {
				return t.simWhyIncompleteDfaTitle;
			} else {
				return t.simWhyNfaTitle;
			}
		}();
		var reasons = function () {
			if (autoType.$ === 'IncompleteDFA') {
				...
				return _Utils_ap(
					hasEpsilon ? _List_fromArray(
						[t.simWhyNfaEpsilon]) : _List_Nil,
					hasNonDeterminism ? _List_fromArray(
						[t.simWhyNfaNondet]) : _List_Nil);
			}
		}();
		return A2(
...
var $author$project$Pages$Simulator$view = F9(
	function (consoleOpen, darkMode, settingsOpen, language, tutorialInputHighlight, tutorialButtonsHighlight, windowWidth, windowHeight, model) {
		var theme = $author$project$Utils$Theme$getTheme(darkMode);
		var t = $author$project$Utils$Translations$getTranslations(language);
		...
		var hasNonDeterminism = function () {
			var key = function (tr) {
				return $elm$core$String$fromInt(tr.from) + ('|' + tr.symbol);
			};
			var checkDups = F2(
				function (tl, seen) {
					checkDups:
		...
		var efficientHighlights = function () {
			var _v22 = model.efficientResult;
			if (_v22.$ === 'Just') {
				var result = _v22.a;
				return A2(
					$elm$core$List$map,
							...
							_List_fromArray(
								[
									...
									model.efficientMode ? _List_fromArray(
										[
											A2($author$project$Pages$Simulator$viewDisabledToggleTab, theme, t.simAutomatonTab),
											A2($author$project$Pages$Simulator$viewDisabledToggleTab, theme, t.simTreeTab)
										]) : _List_fromArray(
										[
									...
									_List_fromArray(
										[
											function () {
											if (_Utils_eq(model.mode, $author$project$Pages$Simulator$DfaMode) || (model.showCanvas || model.efficientMode)) {
												var targetState = function (ms) {
													if (ms.$ === 'Just') {
														var s = ms.a;
														return $elm$core$Maybe$Just(s);
													...
													_List_fromArray(
														[
															$author$project$Components$Canvas$view(
															{
																...
																highlightedSymbols: _List_Nil,
																highlightedTransitions: _List_Nil,
																isSimulateMode: true,
																onArrowMouseDown: F4(
																	function (_v1, _v2, _v3, _v4) {
																		return A2($author$project$Pages$Simulator$CanvasClick, 0, 0);
																	}),
																onArrowRightClick: F2(
																	function (_v5, _v6) {
																		return A2($author$project$Pages$Simulator$CanvasClick, 0, 0);
																	}),
																...
																onStateDoubleClick: function (_v12) {
																	return A2($author$project$Pages$Simulator$CanvasClick, 0, 0);
																},
																onStateRightClick: function (_v13) {
																	return A2($author$project$Pages$Simulator$CanvasClick, 0, 0);
																},
																onTransitionClick: $author$project$Pages$Simulator$TransitionClick,
																onTransitionRightClick: F3(
																	function (_v14, _v15, _v16) {
																		return A2($author$project$Pages$Simulator$CanvasClick, 0, 0);
																	}),
																onWheel: F3(
																	function (d, x, y) {
															...
															_Utils_ap(
																...
																targetVisible ? _List_fromArray(
																	...
																	[
																		$elm$html$Html$Events$onClick(
																		A2($author$project$Pages$Simulator$RecenterCanvas, canvasW, canvasH))
																	])),
															_List_fromArray(
																[
																	$elm$html$Html$text(t.editorRecenter)
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										...
										tutorialInputHighlight ? _List_fromArray(
											[
												A2($elm$html$Html$Attributes$style, 'position', 'relative'),
												A2($elm$html$Html$Attributes$style, 'z-index', '501'),
												A2($elm$html$Html$Attributes$style, 'box-shadow', theme.yellowGlowShadow)
										...
										[
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$style,
													'border',
													$elm$core$String$isEmpty(model.inputString) ? ('2px solid ' + theme.rejectFillColor) : ('1px solid ' + theme.inputBorder)),
													A2($elm$html$Html$Attributes$style, 'border-radius', '4px'),
													A2($elm$html$Html$Attributes$style, 'box-sizing', 'border-box'),
													A2($elm$html$Html$Attributes$style, 'background-color', theme.inputBg),
													A2($elm$html$Html$Attributes$style, 'color', theme.inputText),
													...
													$elm$html$Html$Attributes$style,
													'outline',
													$elm$core$String$isEmpty(model.inputString) ? 'none' : '')
												]),
											_List_Nil),
											function () {
											if ($elm$core$String$isEmpty(model.inputString)) {
												return A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															A2($elm$html$Html$Attributes$style, 'color', theme.rejectFillColor),
															A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
															A2($elm$html$Html$Attributes$style, 'margin-top', '4px')
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(t.simInputEmptyError)
														]));
											} else {
												var alphabet = A2(
													$elm$core$List$filter,
												...
												var hasUnknownSymbol = A2(
													...
													$elm$core$String$toList(model.inputString));
												return hasUnknownSymbol ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															A2($elm$html$Html$Attributes$style, 'color', theme.warningColor),
															A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
															A2($elm$html$Html$Attributes$style, 'margin-top', '4px')
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(t.simInputUnknownSymbols)
														])) : $elm$html$Html$text('');
											}
										}()
										])),
									A4(
									$author$project$Pages$Simulator$viewReadingHead,
									theme,
									A2(
										$elm$core$List$filter,
										function (s) {
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													_Utils_eq(model.automatonType, $author$project$Shared$IncompleteDFA) ? A5($author$project$Pages$Simulator$viewWhyNfaBlock, theme, t, model.automatonType, hasEpsilon, hasNonDeterminism) : $elm$html$Html$text('')
												]));
									} else {
										return A2(
											$elm$html$Html$div,
											...
											_List_fromArray(
												[
													...
													A5($author$project$Pages$Simulator$viewWhyNfaBlock, theme, t, model.automatonType, hasEpsilon, hasNonDeterminism),
													A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
																...
																[
																	...
																	_List_fromArray(
																		[
																			...
																			A2($elm$html$Html$Attributes$style, 'height', '14px'),
																			A2($elm$html$Html$Attributes$style, 'border-radius', '50%'),
																			A2($elm$html$Html$Attributes$style, 'background', theme.neutralGrayBg),
																			A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
													...
													_List_fromArray(
														[
															A2($elm$html$Html$Attributes$style, 'padding', '6px 15px'),
															A2($elm$html$Html$Attributes$style, 'border-top', '1px solid ' + theme.lightDividerBorder),
															A2($elm$html$Html$Attributes$style, 'display', 'flex'),
															A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
															A2($elm$html$Html$Attributes$style, 'gap', '6px')
														]),
													...
													_List_fromArray(
														[
															...
															function () {
															var _v20 = model.efficientResult;
															if (_v20.$ === 'Just') {
																var result = _v20.a;
																return A2(
																	$elm$html$Html$div,
																	_List_fromArray(
																		[
																			...
																			$elm$html$Html$Attributes$style,
																			'border-left',
																			result.isAccepted ? ('4px solid ' + theme.acceptFillColor) : ('4px solid ' + theme.rejectFillColor))
																		]),
																	_List_fromArray(
																		[
																			A2(
		...
		return {
			...
			rows: _List_fromArray(
				[
					...
					A2($author$project$Utils$Translations$row, 'Autor', 'Jakub Mitický'),
					A2($author$project$Utils$Translations$row, 'Vedúci práce', 'Ing. Ivan Kapustík')
				]),
		...
		return {
			...
			rows: _List_fromArray(
				[
					...
					A2($author$project$Utils$Translations$row, 'Author', 'Jakub Mitický'),
					A2($author$project$Utils$Translations$row, 'Supervisor', 'Ing. Ivan Kapustík')
				]),
...
var $author$project$Utils$ExampleAutomata$example1 = function (t) {
	return {
		automaton: {
			...
			states: _List_fromArray(
				[
					{id: 0, isCompact: false, isEnd: false, isStart: true, label: 'q0', startAngle: $elm$core$Basics$pi, x: 200, y: 280},
					{id: 1, isCompact: false, isEnd: true, isStart: false, label: 'q1', startAngle: $elm$core$Basics$pi, x: 520, y: 280}
				]),
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: 'a', to: 1},
					{bend: 0, from: 0, symbol: 'b', to: 0},
					{bend: 0, from: 1, symbol: 'a', to: 1},
					{bend: 0, from: 1, symbol: 'b', to: 0}
				])
		},
...
var $author$project$Utils$ExampleAutomata$example2 = function (t) {
	return {
		automaton: {
			...
			states: _List_fromArray(
				[
					{id: 0, isCompact: false, isEnd: true, isStart: true, label: 'even', startAngle: $elm$core$Basics$pi, x: 200, y: 280},
					{id: 1, isCompact: false, isEnd: false, isStart: false, label: 'odd', startAngle: $elm$core$Basics$pi, x: 520, y: 280}
				]),
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: '0', to: 1},
					{bend: 0, from: 0, symbol: '1', to: 0},
					{bend: 0, from: 1, symbol: '0', to: 0},
					{bend: 0, from: 1, symbol: '1', to: 1}
				])
		},
...
var $author$project$Utils$ExampleAutomata$example3 = function (t) {
	return {
		automaton: {
			...
			states: _List_fromArray(
				[
					{id: 0, isCompact: false, isEnd: false, isStart: true, label: 'q0', startAngle: $elm$core$Basics$pi, x: 150, y: 280},
					{id: 1, isCompact: false, isEnd: false, isStart: false, label: 'q1', startAngle: $elm$core$Basics$pi, x: 370, y: 280},
					{id: 2, isCompact: false, isEnd: true, isStart: false, label: 'q2', startAngle: $elm$core$Basics$pi, x: 590, y: 280}
				]),
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: '0', to: 0},
					{bend: 0, from: 0, symbol: '1', to: 0},
					{bend: 0, from: 0, symbol: '0', to: 1},
					{bend: 0, from: 1, symbol: '1', to: 2}
				])
		},
	...
	return {
		automaton: {
			...
			states: _List_fromArray(
				[
					{id: 0, isCompact: false, isEnd: false, isStart: true, label: 'q0', startAngle: $elm$core$Basics$pi, x: 150, y: 280},
					{id: 1, isCompact: false, isEnd: false, isStart: false, label: 'q1', startAngle: $elm$core$Basics$pi, x: 360, y: 280},
					{id: 2, isCompact: false, isEnd: true, isStart: false, label: 'q2', startAngle: $elm$core$Basics$pi, x: 570, y: 170},
					{id: 3, isCompact: false, isEnd: true, isStart: false, label: 'q3', startAngle: $elm$core$Basics$pi, x: 570, y: 390}
				]),
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: 'a', to: 1},
					{bend: 0, from: 1, symbol: 'ε', to: 2},
					{bend: 0, from: 1, symbol: 'b', to: 3}
				])
		},
		...
		automaton: {
			...
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: '0', to: 0},
					{bend: 0, from: 0, symbol: '1', to: 0},
					{bend: 0, from: 0, symbol: '1', to: 1},
					{bend: 0, from: 1, symbol: '0', to: 2},
					{bend: 0, from: 1, symbol: '1', to: 2}
				])
		},
...
var $author$project$Utils$ExampleAutomata$example6 = function (t) {
	return {
		automaton: {
			...
			states: _List_fromArray(
				[
					{id: 0, isCompact: false, isEnd: true, isStart: true, label: 'q0', startAngle: $elm$core$Basics$pi, x: 200, y: 280},
					{id: 1, isCompact: false, isEnd: true, isStart: false, label: 'q1', startAngle: $elm$core$Basics$pi, x: 520, y: 280}
				]),
			transitions: _List_fromArray(
				[
					{bend: 0, from: 0, symbol: 'a', to: 0},
					{bend: 0, from: 0, symbol: 'ε', to: 1},
					{bend: 0, from: 1, symbol: 'b', to: 1}
				])
		},
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$Utils$Translations$row, 'Premenovanie stavu', 'Pravý klik na stav -> upraviť názov v modáli'),
							A2($author$project$Utils$Translations$row, 'Nastavenie počiatočného stavu', 'Pravý klik na stav -> zaškrtnúť Počiatočný stav'),
							A2($author$project$Utils$Translations$row, 'Nastavenie koncového stavu', 'Pravý klik na stav -> zaškrtnúť Koncový stav'),
							A2($author$project$Utils$Translations$row, 'Pridanie prechodu', 'Kliknutie na zdrojový stav, potom kliknutie na cieľový stav'),
							A2($author$project$Utils$Translations$row, 'Pridanie slučky (self-loop)', 'Rýchly dvojklik na stav'),
							...
							A2($author$project$Utils$Translations$row, 'Úprava symbolu prechodu', 'Klik na symbol prechodu'),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($author$project$Utils$Translations$row, 'Rename state', 'Right-click on a state -> edit the name in the modal'),
							A2($author$project$Utils$Translations$row, 'Set start state', 'Right-click on a state -> check Start state'),
							A2($author$project$Utils$Translations$row, 'Set end state', 'Right-click on a state -> check End state'),
							A2($author$project$Utils$Translations$row, 'Add transition', 'Click the source state, then click the target state'),
							A2($author$project$Utils$Translations$row, 'Add self-loop', 'Fast double-click on a state'),
							...
							A2($author$project$Utils$Translations$row, 'Edit transition symbol', 'Click the transition symbol'),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$StartTutorial),
							A2($elm$html$Html$Attributes$style, 'background-color', theme.relaunchBtnBg),
							A2($elm$html$Html$Attributes$style, 'border', 'none'),
							A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
							A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
							A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
					...
					_List_fromArray(
						[
							$elm$html$Html$text(t.tutRelaunch)
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'background-color',
					_Utils_eq(tab, current) ? theme.modalTabActiveBg : theme.colorTransparent),
					A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
					A2($elm$html$Html$Attributes$style, 'border', 'none'),
					A2(
					$elm$html$Html$Attributes$style,
					'border-bottom',
					_Utils_eq(tab, current) ? ('2px solid ' + theme.modalTabActiveBorder) : ('2px solid ' + theme.colorTransparent)),
					A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
					A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
					A2(
					$elm$html$Html$Attributes$style,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'width', '100%'),
					A2($elm$html$Html$Attributes$style, 'height', '100%'),
					A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayDark60),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
							A2($elm$html$Html$Attributes$style, 'overflow', 'hidden'),
							A2($elm$html$Html$Attributes$style, 'box-shadow', '0 8px 32px ' + theme.overlayDark50),
							A2(
							$elm$html$Html$Events$stopPropagationOn,
							'click',
							$elm$json$Json$Decode$succeed(
...
var $author$project$Main$TutorialNext = {$: 'TutorialNext'};
var $author$project$Main$TutorialSkip = {$: 'TutorialSkip'};
var $author$project$Main$tutorialStepIndex = function (step) {
	switch (step.$) {
		case 'TutWelcome':
			return 0;
		case 'TutToolbarUndoRedo':
...
var $author$project$Main$tutorialStepText = F2(
	function (t, step) {
		switch (step.$) {
			case 'TutWelcome':
				return '';
			...
			case 'TutCreateTransition':
				return t.tutStep5;
			case 'TutToolbarUndoRedo':
				return t.tutStepUndoRedo;
			case 'TutToolbarTools':
				return t.tutStepTools;
			case 'TutToolbarFiles':
				return t.tutStepFiles;
			case 'TutToolbarConvert':
				return t.tutStepConvert;
			case 'TutSimulateButton':
				return t.tutStep6;
			case 'TutEnterInput':
				return t.tutStep7;
...
var $author$project$Main$viewTutorialTooltip = F3(
	function (theme, t, step) {
		var total = 12;
		var showSkipOnly = _Utils_eq(step, $author$project$Main$TutSimulateButton);
		var isToolbarExplainStep = A2(
			$elm$core$List$member,
			step,
			_List_fromArray(
				[$author$project$Main$TutToolbarUndoRedo, $author$project$Main$TutToolbarTools, $author$project$Main$TutToolbarFiles, $author$project$Main$TutToolbarConvert]));
		var instructionText = A2($author$project$Main$tutorialStepText, t, step);
		var idx = $author$project$Main$tutorialStepIndex(step);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'left', 'calc((100vw - 302px) * 0.2)'),
					A2($elm$html$Html$Attributes$style, 'width', 'calc((100vw - 302px) * 0.6)'),
					A2($elm$html$Html$Attributes$style, 'background-color', theme.tutorialTooltipBg),
					A2($elm$html$Html$Attributes$style, 'color', theme.tutorialTooltipText),
					A2($elm$html$Html$Attributes$style, 'z-index', '502'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
					A2($elm$html$Html$Attributes$style, 'padding', '16px 20px'),
					A2($elm$html$Html$Attributes$style, 'box-sizing', 'border-box'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '12px'),
					A2($elm$html$Html$Attributes$style, 'box-shadow', '0 6px 32px ' + (theme.overlayDark60 + (', 0 0 0 1px ' + theme.overlayLight08))),
					A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + theme.overlayLight50),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(idx) + (' / ' + $elm$core$String$fromInt(total)))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							step,
							_List_fromArray(
								[$author$project$Main$TutCreateState1, $author$project$Main$TutCreateState2, $author$project$Main$TutSetStart, $author$project$Main$TutSetEnd, $author$project$Main$TutCreateTransition])) ? A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'margin-top', '8px'),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayLight20),
											A2($elm$html$Html$Attributes$style, 'border', '1px solid ' + theme.overlayLight50),
											A2($elm$html$Html$Attributes$style, 'border-radius', '4px'),
									...
									_List_fromArray(
										[
											$elm$html$Html$text('ESC')
										])),
									$elm$html$Html$text(t.tutTipEscape)
								])) : $elm$html$Html$text('')
						])),
					A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$TutorialSkip),
									A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayLight12),
									A2($elm$html$Html$Attributes$style, 'color', theme.tutorialTooltipText),
									A2($elm$html$Html$Attributes$style, 'border', '1px solid ' + theme.overlayLight30),
									A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
									A2($elm$html$Html$Attributes$style, 'padding', '6px 14px'),
									A2($elm$html$Html$Attributes$style, 'font-size', '13px'),
									A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutSkip)
								])),
							isToolbarExplainStep ? A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$TutorialNext),
									A2($elm$html$Html$Attributes$style, 'background-color', theme.btnPrimary),
									A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
									A2($elm$html$Html$Attributes$style, 'border', 'none'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutUnderstand)
								])) : (showSkipOnly ? $elm$html$Html$text('') : (_Utils_eq(step, $author$project$Main$TutRunSimulation) ? A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$TutorialSkip),
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutFinish)
								])) : $elm$html$Html$text('')))
						]))
				]));
	});
var $author$project$Main$viewTutorialVeils = F3(
	function (theme, step, currentPage) {
		var veilRight = F4(
			function (top, right, width, height) {
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'right', right),
							A2($elm$html$Html$Attributes$style, 'width', width),
							A2($elm$html$Html$Attributes$style, 'height', height),
							A2($elm$html$Html$Attributes$style, 'background-color', theme.tutorialVeilBg),
							A2($elm$html$Html$Attributes$style, 'z-index', '500')
						]),
					_List_Nil);
			});
		var veilLeft = F4(
		...
		var canvasPhaseVeils = A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					A4(veilLeft, '0', '0', '100%', '80px'),
					A4(veilRight, '80px', '0', '302px', 'calc(100vh - 80px)')
				]));
		if (currentPage.$ === 'EditorPage') {
			switch (step.$) {
				case 'TutCreateState1':
					return canvasPhaseVeils;
				case 'TutCreateState2':
					return canvasPhaseVeils;
				case 'TutSetStart':
					return canvasPhaseVeils;
				...
				case 'TutToolbarUndoRedo':
					return A2(
						...
						_List_fromArray(
							[
								A4(veilLeft, '80px', '0', 'calc(100% - 302px)', 'calc(100vh - 80px)'),
								A4(veilRight, '80px', '0', '302px', 'calc(100vh - 80px)')
							]));
				case 'TutToolbarTools':
					return A2(
...
var $author$project$Main$ToggleGridMode = {$: 'ToggleGridMode'};
var $author$project$Main$ToggleLanguage = {$: 'ToggleLanguage'};
var $author$project$Main$TutorialWelcomeContinue = {$: 'TutorialWelcomeContinue'};
var $author$project$Main$tutorialPillToggle = F3(
	function (theme, onToggle, isOn) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Main$viewTutorialWelcome = F3(
	function (theme, t, model) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'width', '100%'),
					A2($elm$html$Html$Attributes$style, 'height', '100%'),
					A2($elm$html$Html$Attributes$style, 'background-color', theme.overlayDark70),
					A2($elm$html$Html$Attributes$style, 'z-index', '3000'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
					A2($elm$html$Html$Attributes$style, 'justify-content', 'center')
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutWelcomeTitle)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutWelcomeBody)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A3($author$project$Main$tutorialPillToggle, theme, $author$project$Main$ToggleDarkMode, model.darkMode)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'space-between'),
									A2($elm$html$Html$Attributes$style, 'margin-bottom', '28px')
								]),
							_List_fromArray(
								[
									A2(
									...
									A3($author$project$Main$tutorialPillToggle, theme, $author$project$Main$ToggleGridMode, model.gridMode)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$TutorialWelcomeContinue),
									A2($elm$html$Html$Attributes$style, 'width', '100%'),
									A2($elm$html$Html$Attributes$style, 'padding', '13px'),
									A2($elm$html$Html$Attributes$style, 'background-color', theme.btnPrimary),
									A2($elm$html$Html$Attributes$style, 'color', theme.textOnDark),
									A2($elm$html$Html$Attributes$style, 'border', 'none'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
							...
							_List_fromArray(
								[
									$elm$html$Html$text(t.tutContinueToTutorial)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(t.tutSkipTutorial)
										]))
								]))
						]))
				]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				switch (_v0.$) {
					case 'EditorPage':
						return A2(
							...
							A8(
								$author$project$Pages$Editor$view,
								model.consoleOpen,
								model.darkMode,
								model.settingsOpen,
								model.language,
								model.windowWidth,
								model.windowHeight,
								$author$project$Main$tutorialHighlightForEditor(model.tutorialStep),
								model.editorModel));
					case 'SimulatorPage':
						return A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									$author$project$Main$SimulatorMsg,
									A9(
										$author$project$Pages$Simulator$view,
										model.consoleOpen,
										model.darkMode,
										model.settingsOpen,
										model.language,
										_Utils_eq(
											model.tutorialStep,
											$elm$core$Maybe$Just($author$project$Main$TutEnterInput)),
										_Utils_eq(
											model.tutorialStep,
											$elm$core$Maybe$Just($author$project$Main$TutRunSimulation)),
										model.windowWidth,
				...
				function () {
				var _v1 = model.tutorialStep;
				if (_v1.$ === 'Just') {
					if (_v1.a.$ === 'TutWelcome') {
						var _v2 = _v1.a;
						return A3($author$project$Main$viewTutorialWelcome, theme, t, model);
					} else {
						var step = _v1.a;
						return A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									A3($author$project$Main$viewTutorialVeils, theme, step, model.currentPage),
									A3($author$project$Main$viewTutorialTooltip, theme, t, step)
								]));
					}
				} else {
					return $elm$html$Html$text('');
